    ...
    get() {
        ...
        _laugh = Builder(name = "Laugh", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.0f, 14.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, -0.963f, 1.285f)
                arcTo(5.5f, 5.5f, 0.0f, false, false, 12.007f, 19.0f)
                arcToRelative(5.469f, 5.469f, 0.0f, false, false, 4.966f, -3.715f)
                arcTo(1.021f, 1.021f, 0.0f, false, false, 16.01f, 14.0f)
                close()
                moveTo(6.0f, 10.0f)
