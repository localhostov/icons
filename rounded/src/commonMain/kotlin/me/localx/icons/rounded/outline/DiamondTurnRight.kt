    ...
    get() {
        ...
        _diamondTurnRight = Builder(name = "DiamondTurnRight", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(1.939f, -1.94f, 1.939f, -5.097f, 0.0f, -7.037f)
                close()
                moveTo(21.129f, 14.104f)
                lineToRelative(-7.024f, 7.024f)
                curveToRelative(-1.16f, 1.158f, -3.049f, 1.158f, -4.209f, 0.0f)
                lineTo(2.871f, 14.104f)
                curveToRelative(-1.159f, -1.16f, -1.159f, -3.049f, 0.0f, -4.209f)
                lineTo(9.896f, 2.871f)
                curveToRelative(1.16f, -1.16f, 3.049f, -1.16f, 4.209f, 0.0f)
                lineToRelative(7.024f, 7.024f)
                curveToRelative(1.159f, 1.16f, 1.159f, 3.049f, 0.0f, 4.209f)
                close()
                moveTo(17.128f, 8.878f)
