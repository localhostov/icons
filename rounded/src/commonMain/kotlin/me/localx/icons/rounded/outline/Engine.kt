...
public val Icons.Outline.Engine: ImageVector
    get() {
        if (_engine != null) {
            return _engine!!
        }
        _engine = Builder(name = "Engine", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, -0.276f, 0.224f, -0.5f, 0.5f, -0.5f)
                horizontalLineToRelative(0.5f)
                curveToRelative(0.297f, 0.0f, 0.578f, -0.132f, 0.768f, -0.36f)
                lineToRelative(1.901f, -2.28f)
                curveToRelative(0.19f, -0.229f, 0.47f, -0.36f, 0.768f, -0.36f)
                horizontalLineToRelative(7.063f)
