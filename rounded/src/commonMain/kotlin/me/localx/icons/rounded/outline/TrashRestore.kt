    ...
    get() {
        ...
        _trashRestore = Builder(name = "TrashRestore", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.957f, 19.283f)
                curveToRelative(-0.147f, 1.549f, -1.431f, 2.717f, -2.987f, 2.717f)
                horizontalLineToRelative(-5.727f)
                curveToRelative(-1.554f, 0.0f, -2.838f, -1.167f, -2.987f, -2.713f)
                lineToRelative(-1.277f, -13.287f)
                horizontalLineToRelative(14.237f)
                lineToRelative(-1.259f, 13.283f)
                close()
                moveTo(15.707f, 12.481f)
