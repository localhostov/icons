    ...
    get() {
        ...
        _headset = Builder(name = "Headset", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(5.5303f, 21.9996f, 6.039f, 21.7889f, 6.4141f, 21.4138f)
                curveTo(6.7892f, 21.0388f, 6.9999f, 20.5301f, 6.9999f, 19.9996f)
                verticalLineTo(13.9996f)
                curveTo(6.9999f, 13.4692f, 6.7892f, 12.9605f, 6.4141f, 12.5854f)
                curveTo(6.039f, 12.2103f, 5.5303f, 11.9996f, 4.9999f, 11.9996f)
                verticalLineTo(10.9996f)
                ...
                curveTo(18.4695f, 11.9996f, 17.9607f, 12.2103f, 17.5857f, 12.5854f)
                curveTo(17.2106f, 12.9605f, 16.9999f, 13.4692f, 16.9999f, 13.9996f)
                verticalLineTo(19.9996f)
                horizontalLineTo(13.9999f)
                curveTo(13.7347f, 19.9996f, 13.4803f, 20.105f, 13.2928f, 20.2925f)
                curveTo(13.1052f, 20.4801f, 12.9999f, 20.7344f, 12.9999f, 20.9996f)
                curveTo(12.9999f, 21.2649f, 13.1052f, 21.5192f, 13.2928f, 21.7067f)
                curveTo(13.4803f, 21.8943f, 13.7347f, 21.9996f, 13.9999f, 21.9996f)
