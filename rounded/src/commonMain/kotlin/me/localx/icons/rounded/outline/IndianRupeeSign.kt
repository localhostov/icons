...
public val Icons.Outline.IndianRupeeSign: ImageVector
    get() {
        ...
        _indianRupeeSign = Builder(name = "IndianRupeeSign", defaultWidth = 512.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(2.86f, 0.0f, 5.22f, -2.2f, 5.48f, -5.0f)
                horizontalLineTo(4.0f)
                curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f)
                reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f)
                horizontalLineTo(14.79f)
                curveToRelative(-0.65f, -2.31f, -2.78f, -4.0f, -5.29f, -4.0f)
                horizontalLineTo(4.0f)
                curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f)
                reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f)
                ...
                curveToRelative(1.13f, 1.05f, 1.94f, 2.44f, 2.25f, 4.0f)
