    ...
    get() {
        ...
        _planetMoon = Builder(name = "PlanetMoon", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(0.0f, 19.29f, 0.0f, 13.5f)
                reflectiveCurveTo(4.71f, 3.0f, 10.5f, 3.0f)
                reflectiveCurveToRelative(10.5f, 4.71f, 10.5f, 10.5f)
                close()
                moveTo(14.536f, 13.03f)
                ...
                curveToRelative(-3.283f, 0.068f, -6.114f, 2.006f, -7.469f, 4.791f)
