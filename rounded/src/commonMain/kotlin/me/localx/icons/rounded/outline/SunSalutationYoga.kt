    ...
    get() {
        ...
        _sunSalutationYoga = Builder(name = "SunSalutationYoga", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.196f, -0.477f, 0.645f, -1.682f, 0.691f, -2.816f)
                curveToRelative(0.023f, -0.552f, -0.405f, -1.018f, -0.958f, -1.041f)
                curveToRelative(-0.51f, -0.011f, -1.017f, 0.405f, -1.04f, 0.958f)
                curveToRelative(-0.025f, 0.603f, -0.225f, 1.271f, -0.388f, 1.73f)
                lineToRelative(-0.2f, -0.1f)
                curveToRelative(-0.682f, -0.341f, -1.105f, -1.026f, -1.105f, -1.789f)
                verticalLineToRelative(-4.646f)
                curveToRelative(0.0f, -0.551f, 0.448f, -1.0f, 1.0f, -1.0f)
                curveToRelative(0.309f, 0.0f, 0.604f, 0.107f, 0.84f, 0.303f)
                lineToRelative(2.251f, 3.093f)
