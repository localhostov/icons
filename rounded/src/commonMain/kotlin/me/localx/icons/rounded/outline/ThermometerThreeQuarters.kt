...
public val Icons.Outline.ThermometerThreeQuarters: ImageVector
    get() {
        ...
        _thermometerThreeQuarters = Builder(name = "ThermometerThreeQuarters", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveToRelative(12.904f, 14.184f)
                ...
                close()
                moveTo(11.904f, 18.0f)
                curveToRelative(-0.551f, 0.0f, -1.0f, -0.448f, -1.0f, -1.0f)
                reflectiveCurveToRelative(0.449f, -1.0f, 1.0f, -1.0f)
                reflectiveCurveToRelative(1.0f, 0.448f, 1.0f, 1.0f)
                reflectiveCurveToRelative(-0.449f, 1.0f, -1.0f, 1.0f)
                close()
                moveTo(16.904f, 12.111f)
                ...
                reflectiveCurveToRelative(3.0f, 1.346f, 3.0f, 3.0f)
                verticalLineToRelative(7.537f)
                curveToRelative(0.0f, 0.284f, 0.121f, 0.555f, 0.333f, 0.744f)
                curveToRelative(1.06f, 0.951f, 1.667f, 2.306f, 1.667f, 3.719f)
                curveToRelative(0.0f, 2.757f, -2.243f, 5.0f, -5.0f, 5.0f)
                close()
            }
        }
