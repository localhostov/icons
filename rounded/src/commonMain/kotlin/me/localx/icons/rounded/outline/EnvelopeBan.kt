    ...
    get() {
        ...
        _envelopeBan = Builder(name = "EnvelopeBan", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(1.87f, -1.836f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 1.4f, 1.428f)
                lineToRelative(-1.864f, 1.828f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, -7.065f, -0.006f)
                lineTo(2.0f, 9.071f)
                lineTo(2.0f, 19.0f)
