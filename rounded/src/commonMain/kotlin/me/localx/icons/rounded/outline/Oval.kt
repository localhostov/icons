...
public val Icons.Outline.Oval: ImageVector
    get() {
        if (_oval != null) {
            return _oval!!
        }
        _oval = Builder(name = "Oval", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 6.0f)
                curveToRelative(-5.42f, 0.0f, -10.0f, 2.748f, -10.0f, 6.0f)
                reflectiveCurveToRelative(4.58f, 6.0f, 10.0f, 6.0f)
                reflectiveCurveToRelative(10.0f, -2.748f, 10.0f, -6.0f)
                reflectiveCurveToRelative(-4.58f, -6.0f, -10.0f, -6.0f)
                close()
            }
        }
