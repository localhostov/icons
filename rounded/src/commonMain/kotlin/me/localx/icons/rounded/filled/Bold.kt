...
public val Icons.Filled.Bold: ImageVector
    get() {
        if (_bold != null) {
            return _bold!!
        }
        _bold = Builder(name = "Bold", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    moveTo(22.0f, 17.0f)
                    curveTo(21.9983f, 15.6683f, 21.6167f, 14.3647f, 20.9f, 13.2422f)
                    curveTo(20.1833f, 12.1197f, 19.1614f, 11.225f, 17.954f, 10.663f)
                    ...
                    curveTo(16.8559f, 23.9979f, 18.6351f, 23.2597f, 19.9474f, 21.9474f)
                    curveTo(21.2597f, 20.6351f, 21.9979f, 18.8559f, 22.0f, 17.0f)
                    close()
                    moveTo(7.0f, 4.0f)
