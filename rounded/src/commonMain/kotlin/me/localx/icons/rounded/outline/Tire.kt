    ...
    get() {
        ...
        _tire = Builder(name = "Tire", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(2.128f, 2.128f, 0.0f, false, true, 0.914f, 3.253f)
                lineToRelative(-1.1f, 1.463f)
                arcTo(5.983f, 5.983f, 0.0f, false, true, 6.0f, 12.0f)
                close()
                moveTo(9.247f, 17.33f)
                lineTo(10.4f, 15.8f)
                arcToRelative(2.057f, 2.057f, 0.0f, false, true, 3.2f, 0.0f)
                lineToRelative(1.149f, 1.531f)
                arcTo(6.042f, 6.042f, 0.0f, false, true, 9.247f, 17.33f)
                close()
                moveTo(16.347f, 16.13f)
                lineTo(15.691f, 15.257f)
                lineTo(15.249f, 14.667f)
