    ...
    get() {
        ...
        _arrowUpSquareTriangle = Builder(name = "ArrowUpSquareTriangle", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(21.458f, 20.862f)
                curveToRelative(-0.038f, 0.063f, -0.11f, 0.139f, -0.244f, 0.139f)
                horizontalLineToRelative(-5.43f)
                curveToRelative(-0.133f, 0.0f, -0.206f, -0.075f, -0.244f, -0.139f)
                curveToRelative(-0.038f, -0.063f, -0.069f, -0.163f, -0.032f, -0.234f)
                lineToRelative(2.741f, -4.479f)
                curveToRelative(0.067f, -0.123f, 0.172f, -0.148f, 0.25f, -0.148f)
                reflectiveCurveToRelative(0.183f, 0.026f, 0.275f, 0.194f)
                lineToRelative(2.688f, 4.387f)
                curveToRelative(0.063f, 0.117f, 0.032f, 0.217f, -0.005f, 0.28f)
                close()
