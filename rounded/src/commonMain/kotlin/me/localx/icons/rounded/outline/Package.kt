        ...
        _package = Builder(name = "Package", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    moveTo(21.0f, 7.9998f)
                    horizontalLineTo(17.0f)
                    curveTo(16.2044f, 7.9998f, 15.4413f, 8.3159f, 14.8787f, 8.8785f)
                    curveTo(14.3161f, 9.4411f, 14.0f, 10.2041f, 14.0f, 10.9998f)
                    ...
                    lineTo(0.0f, 22.9998f)
                    curveTo(0.0f, 23.265f, 0.1054f, 23.5194f, 0.2929f, 23.7069f)
                    curveTo(0.4804f, 23.8944f, 0.7348f, 23.9998f, 1.0f, 23.9998f)
                    curveTo(1.2652f, 23.9998f, 1.5196f, 23.8944f, 1.7071f, 23.7069f)
                    curveTo(1.8946f, 23.5194f, 2.0f, 23.265f, 2.0f, 22.9998f)
                    verticalLineTo(17.9998f)
                    horizontalLineTo(22.0f)
                    verticalLineTo(22.9998f)
                    curveTo(22.0f, 23.265f, 22.1054f, 23.5194f, 22.2929f, 23.7069f)
                    curveTo(22.4804f, 23.8944f, 22.7348f, 23.9998f, 23.0f, 23.9998f)
                    curveTo(23.2652f, 23.9998f, 23.5196f, 23.8944f, 23.7071f, 23.7069f)
                    curveTo(23.8946f, 23.5194f, 24.0f, 23.265f, 24.0f, 22.9998f)
                    verticalLineTo(10.9998f)
                    curveTo(24.0f, 10.2041f, 23.6839f, 9.4411f, 23.1213f, 8.8785f)
                    curveTo(22.5587f, 8.3159f, 21.7956f, 7.9998f, 21.0f, 7.9998f)
                    close()
                    moveTo(4.0f, 3.9998f)
                    ...
                    close()
                    moveTo(16.0f, 15.9998f)
                    verticalLineTo(10.9998f)
                    curveTo(16.0f, 10.7346f, 16.1054f, 10.4802f, 16.2929f, 10.2927f)
                    curveTo(16.4804f, 10.1051f, 16.7348f, 9.9998f, 17.0f, 9.9998f)
                    horizontalLineTo(18.0f)
                    verticalLineTo(10.9998f)
                    curveTo(18.0f, 11.265f, 18.1054f, 11.5194f, 18.2929f, 11.7069f)
                    curveTo(18.4804f, 11.8944f, 18.7348f, 11.9998f, 19.0f, 11.9998f)
                    curveTo(19.2652f, 11.9998f, 19.5196f, 11.8944f, 19.7071f, 11.7069f)
                    curveTo(19.8946f, 11.5194f, 20.0f, 11.265f, 20.0f, 10.9998f)
                    verticalLineTo(9.9998f)
                    horizontalLineTo(21.0f)
                    curveTo(21.2652f, 9.9998f, 21.5196f, 10.1051f, 21.7071f, 10.2927f)
                    curveTo(21.8946f, 10.4802f, 22.0f, 10.7346f, 22.0f, 10.9998f)
                    verticalLineTo(15.9998f)
