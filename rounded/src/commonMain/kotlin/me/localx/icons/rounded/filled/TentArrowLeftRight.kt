    ...
    get() {
        ...
        _tentArrowLeftRight = Builder(name = "TentArrowLeftRight", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveToRelative(23.133f, 7.093f)
                lineToRelative(-2.4f, 2.585f)
                curveToRelative(-0.196f, 0.212f, -0.465f, 0.319f, -0.732f, 0.319f)
                curveToRelative(-0.244f, 0.0f, -0.488f, -0.088f, -0.681f, -0.268f)
                curveToRelative(-0.404f, -0.375f, -0.428f, -1.008f, -0.052f, -1.413f)
                lineToRelative(2.152f, -2.317f)
                lineTo(2.579f, 5.999f)
                ...
                curveToRelative(-0.269f, 0.0f, -0.535f, -0.107f, -0.732f, -0.319f)
                lineTo(0.842f, 7.067f)
                curveToRelative(-1.129f, -1.128f, -1.129f, -3.006f, 0.025f, -4.16f)
                lineTo(3.268f, 0.322f)
                curveToRelative(0.376f, -0.405f, 1.011f, -0.426f, 1.413f, -0.052f)
                curveToRelative(0.404f, 0.375f, 0.428f, 1.008f, 0.052f, 1.413f)
                lineToRelative(-2.152f, 2.317f)
                horizontalLineToRelative(18.841f)
                lineToRelative(-2.153f, -2.317f)
                curveToRelative(-0.376f, -0.405f, -0.353f, -1.038f, 0.052f, -1.413f)
                curveToRelative(0.403f, -0.377f, 1.035f, -0.353f, 1.413f, 0.052f)
                lineToRelative(2.426f, 2.611f)
                curveToRelative(1.129f, 1.128f, 1.129f, 3.006f, -0.025f, 4.16f)
                close()
