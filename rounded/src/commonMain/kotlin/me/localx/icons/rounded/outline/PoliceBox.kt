    ...
    get() {
        ...
        _policeBox = Builder(name = "PoliceBox", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(3.0f, 7.09f)
                curveToRelative(0.0f, -2.264f, 1.694f, -4.184f, 3.941f, -4.465f)
                ...
                verticalLineToRelative(1.117f)
                lineToRelative(4.059f, 0.507f)
                curveToRelative(2.247f, 0.281f, 3.941f, 2.201f, 3.941f, 4.465f)
                verticalLineToRelative(14.91f)
                horizontalLineToRelative(1.0f)
                curveToRelative(0.553f, 0.0f, 1.0f, 0.448f, 1.0f, 1.0f)
                close()
                moveTo(19.0f, 7.09f)
                curveToRelative(0.0f, -0.389f, -0.09f, -0.759f, -0.251f, -1.09f)
                lineTo(5.251f, 6.0f)
                curveToRelative(-0.161f, 0.331f, -0.251f, 0.701f, -0.251f, 1.09f)
                verticalLineToRelative(14.91f)
