...
public val Icons.Outline.ArrowUpToDottedLine: ImageVector
    get() {
        ...
        _arrowUpToDottedLine = Builder(name = "ArrowUpToDottedLine", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(-0.448f, -1.0f, -1.0f, -1.0f)
                close()
                moveTo(14.121f, 4.879f)
                curveToRelative(-1.133f, -1.134f, -3.123f, -1.12f, -4.229f, -0.014f)
                lineToRelative(-4.586f, 4.414f)
                curveToRelative(-0.398f, 0.383f, -0.41f, 1.016f, -0.027f, 1.414f)
                curveToRelative(0.385f, 0.399f, 1.017f, 0.411f, 1.414f, 0.027f)
                lineToRelative(4.307f, -4.145f)
                lineTo(11.0f, 23.0f)
                curveToRelative(0.0f, 0.552f, 0.448f, 1.0f, 1.0f, 1.0f)
                reflectiveCurveToRelative(1.0f, -0.448f, 1.0f, -1.0f)
                lineTo(13.0f, 6.575f)
                lineToRelative(4.307f, 4.145f)
                curveToRelative(0.194f, 0.187f, 0.443f, 0.279f, 0.693f, 0.279f)
