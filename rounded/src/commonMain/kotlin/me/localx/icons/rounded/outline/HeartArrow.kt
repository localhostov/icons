        ...
        _heartArrow = Builder(name = "HeartArrow", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(14.4499f, 19.1324f)
                    curveTo(14.0391f, 19.4634f, 13.5275f, 19.6439f, 12.9999f, 19.6439f)
                    curveTo(12.4724f, 19.6439f, 11.9607f, 19.4634f, 11.5499f, 19.1324f)
                    curveTo(7.3869f, 15.6434f, 4.9999f, 12.3104f, 4.9999f, 9.9874f)
                    curveTo(4.9451f, 9.0008f, 5.2821f, 8.0324f, 5.9375f, 7.2929f)
                    curveTo(6.5929f, 6.5534f, 7.5138f, 6.1025f, 8.4999f, 6.0384f)
                    curveTo(9.486f, 6.1025f, 10.4069f, 6.5534f, 11.0623f, 7.2929f)
                    curveTo(11.7178f, 8.0324f, 12.0547f, 9.0008f, 11.9999f, 9.9874f)
                    curveTo(11.9999f, 10.2526f, 12.1053f, 10.507f, 12.2928f, 10.6945f)
                    curveTo(12.4804f, 10.8821f, 12.7347f, 10.9874f, 12.9999f, 10.9874f)
                    curveTo(13.2651f, 10.9874f, 13.5195f, 10.8821f, 13.707f, 10.6945f)
                    curveTo(13.8946f, 10.507f, 13.9999f, 10.2526f, 13.9999f, 9.9874f)
                    curveTo(13.9451f, 9.0008f, 14.2821f, 8.0324f, 14.9375f, 7.2929f)
                    curveTo(15.5929f, 6.5534f, 16.5138f, 6.1025f, 17.4999f, 6.0384f)
                    curveTo(18.486f, 6.1025f, 19.4069f, 6.5534f, 20.0623f, 7.2929f)
                    curveTo(20.7178f, 8.0324f, 21.0547f, 9.0008f, 20.9999f, 9.9874f)
                    curveTo(20.9999f, 12.3094f, 18.6119f, 15.6424f, 14.4499f, 19.1324f)
                    close()
                }
            }
        }
