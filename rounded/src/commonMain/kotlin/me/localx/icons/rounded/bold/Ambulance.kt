    ...
    get() {
        ...
        _ambulance = Builder(name = "Ambulance", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveToRelative(23.009f, 11.951f)
                lineToRelative(-1.819f, -4.091f)
                arcToRelative(6.507f, 6.507f, 0.0f, false, false, -5.94f, -3.86f)
                horizontalLineToRelative(-0.458f)
                lineToRelative(-0.549f, -2.642f)
                arcToRelative(1.793f, 1.793f, 0.0f, false, false, -3.479f, 0.0f)
                lineToRelative(-0.554f, 2.642f)
                ...
                arcToRelative(11.424f, 11.424f, 0.0f, false, false, -0.991f, -4.671f)
                close()
                moveTo(21.0f, 17.5f)
                ...
                arcToRelative(3.459f, 3.459f, 0.0f, false, true, 0.75f, 0.091f)
                verticalLineToRelative(4.909f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, 2.0f, 2.0f)
                horizontalLineToRelative(2.586f)
                arcToRelative(8.439f, 8.439f, 0.0f, false, true, 0.414f, 2.622f)
                close()
                moveTo(13.0f, 12.5f)
