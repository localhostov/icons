...
public val Icons.Bold.FeedbackReview: ImageVector
    get() {
        ...
        _feedbackReview = Builder(name = "FeedbackReview", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(1.907f, 0.0f, 3.548f, -1.346f, 3.922f, -3.216f)
                lineToRelative(0.639f, -3.196f)
                curveToRelative(0.371f, -1.856f, -1.049f, -3.588f, -2.942f, -3.588f)
                close()
                moveTo(16.36f, 20.196f)
                curveToRelative(-0.093f, 0.466f, -0.506f, 0.804f, -0.981f, 0.804f)
                horizontalLineToRelative(-6.379f)
                verticalLineToRelative(-4.0f)
                horizontalLineToRelative(7.999f)
                lineToRelative(-0.639f, 3.196f)
                close()
                moveTo(23.763f, 7.177f)
                ...
                curveToRelative(-0.213f, -0.181f, -0.291f, -0.476f, -0.194f, -0.738f)
                close()
                moveTo(4.005f, 10.021f)
                lineToRelative(-1.805f, 1.208f)
                curveToRelative(-0.112f, 0.075f, -0.242f, 0.113f, -0.371f, 0.113f)
                curveToRelative(-0.141f, 0.0f, -0.282f, -0.045f, -0.4f, -0.133f)
                curveToRelative(-0.227f, -0.17f, -0.321f, -0.464f, -0.236f, -0.734f)
                lineToRelative(0.627f, -2.011f)
                lineTo(0.235f, 7.175f)
                curveToRelative(-0.213f, -0.181f, -0.291f, -0.476f, -0.194f, -0.738f)
                curveToRelative(0.096f, -0.262f, 0.346f, -0.437f, 0.626f, -0.437f)
                horizontalLineToRelative(2.001f)
                lineToRelative(0.708f, -1.987f)
