    ...
    get() {
        ...
        _sdCard = Builder(name = "SdCard", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-1.735f, 0.0f, -3.368f, 0.676f, -4.597f, 1.904f)
                lineToRelative(-2.07f, 2.071f)
                curveToRelative(-1.228f, 1.227f, -1.904f, 2.859f, -1.904f, 4.597f)
                ...
                verticalLineToRelative(-9.929f)
                curveToRelative(0.0f, -0.936f, 0.364f, -1.814f, 1.025f, -2.475f)
                lineToRelative(2.07f, -2.071f)
                curveToRelative(0.661f, -0.661f, 1.541f, -1.025f, 2.476f, -1.025f)
                horizontalLineToRelative(5.929f)
                curveToRelative(1.379f, 0.0f, 2.5f, 1.122f, 2.5f, 2.5f)
