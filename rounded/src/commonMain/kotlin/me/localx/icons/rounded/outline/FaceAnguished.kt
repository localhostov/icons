    ...
    get() {
        ...
        _faceAnguished = Builder(name = "FaceAnguished", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(1.5f, 0.672f, 1.5f, 1.5f)
                close()
                moveTo(15.953f, 17.966f)
                curveToRelative(0.173f, 0.509f, -0.23f, 1.033f, -0.768f, 1.033f)
                curveToRelative(-1.534f, 0.0f, -4.841f, 0.0f, -6.384f, 0.0f)
                curveToRelative(-0.54f, 0.0f, -0.943f, -0.53f, -0.765f, -1.04f)
                curveToRelative(0.5f, -1.429f, 2.043f, -2.96f, 3.963f, -2.96f)
                reflectiveCurveToRelative(3.467f, 1.534f, 3.954f, 2.966f)
                close()
            }
        }
        .build()
