        ...
        _copy = Builder(name = "Copy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    verticalLineTo(15.0f)
                    curveTo(2.0f, 15.7956f, 2.3161f, 16.5587f, 2.8787f, 17.1213f)
                    curveTo(3.4413f, 17.6839f, 4.2043f, 18.0f, 5.0f, 18.0f)
                    horizontalLineTo(15.0f)
                    curveTo(15.7956f, 18.0f, 16.5587f, 17.6839f, 17.1213f, 17.1213f)
                    curveTo(17.6839f, 16.5587f, 18.0f, 15.7956f, 18.0f, 15.0f)
                    verticalLineTo(5.0f)
                    curveTo(18.0f, 4.2043f, 17.6839f, 3.4413f, 17.1213f, 2.8787f)
                    curveTo(16.5587f, 2.3161f, 15.7956f, 2.0f, 15.0f, 2.0f)
                    horizontalLineTo(5.0f)
                    close()
                    moveTo(24.0f, 19.0f)
                    verticalLineTo(6.0f)
