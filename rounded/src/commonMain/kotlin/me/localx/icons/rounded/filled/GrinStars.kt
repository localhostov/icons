    ...
    get() {
        ...
        _grinStars = Builder(name = "GrinStars", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.466f, 10.932f)
                lineToRelative(0.519f, -1.606f)
                lineToRelative(-1.366f, -1.0f)
                arcTo(0.734f, 0.734f, 0.0f, false, true, 5.052f, 7.0f)
                lineTo(6.733f, 7.0f)
                ...
                arcTo(0.715f, 0.715f, 0.0f, false, true, 5.466f, 10.932f)
                close()
                ...
                close()
                moveTo(19.287f, 8.327f)
                lineTo(17.921f, 9.327f)
                lineTo(18.44f, 10.933f)
                arcToRelative(0.735f, 0.735f, 0.0f, false, true, -1.134f, 0.818f)
                lineToRelative(-1.343f, -0.988f)
                ...
                arcTo(0.734f, 0.734f, 0.0f, false, true, 13.071f, 7.0f)
