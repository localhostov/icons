        ...
        _lockAlt = Builder(name = "LockAlt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(15.0f, 10.0f)
                    curveTo(14.9981f, 10.5242f, 14.8585f, 11.0387f, 14.5953f, 11.492f)
                    curveTo(14.332f, 11.9453f, 13.9543f, 12.3215f, 13.5f, 12.583f)
                    ...
                    verticalLineTo(12.583f)
                    curveTo(10.046f, 12.3188f, 9.6695f, 11.9397f, 9.4083f, 11.4839f)
                    curveTo(9.1471f, 11.0282f, 9.0105f, 10.5117f, 9.012f, 9.9864f)
                    curveTo(9.0136f, 9.4611f, 9.1534f, 8.9454f, 9.4173f, 8.4912f)
                    curveTo(9.6812f, 8.037f, 10.0599f, 7.6602f, 10.5155f, 7.3987f)
                    curveTo(10.9711f, 7.1372f, 11.4875f, 7.0002f, 12.0128f, 7.0013f)
                    curveTo(12.5381f, 7.0025f, 13.0539f, 7.1419f, 13.5083f, 7.4055f)
                    curveTo(13.9627f, 7.6691f, 14.3397f, 8.0476f, 14.6016f, 8.503f)
                    curveTo(14.8634f, 8.9584f, 15.0008f, 9.4747f, 15.0f, 10.0f)
                    close()
                }
            }
        }
