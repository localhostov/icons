    ...
    get() {
        ...
        _swipeDown = Builder(name = "SwipeDown", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.095f, 0.039f, -0.143f, -0.006f, -0.167f, -0.03f)
                curveToRelative(0.0f, 0.0f, -2.483f, -2.49f, -2.561f, -2.543f)
                curveToRelative(-0.701f, -0.482f, -1.818f, -0.558f, -2.595f, 0.223f)
                ...
                verticalLineToRelative(2.768f)
                close()
                moveTo(3.308f, 10.717f)
                lineTo(0.27f, 7.654f)
                curveToRelative(-0.605f, -0.61f, -0.176f, -1.653f, 0.679f, -1.653f)
                ...
                curveToRelative(0.856f, 0.0f, 1.284f, 1.043f, 0.679f, 1.653f)
