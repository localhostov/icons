    ...
    get() {
        ...
        _cameraRotate = Builder(name = "CameraRotate", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(5.0f, 5.0f)
                curveTo(2.243f, 5.0f, 0.0f, 7.243f, 0.0f, 10.0f)
                ...
                curveToRelative(0.564f, -0.752f, 1.461f, -1.2f, 2.4f, -1.2f)
                horizontalLineToRelative(4.0f)
                curveToRelative(0.938f, 0.0f, 1.835f, 0.448f, 2.399f, 1.199f)
                lineToRelative(1.35f, 1.801f)
                lineTo(6.25f, 3.0f)
                close()
            }
        }
