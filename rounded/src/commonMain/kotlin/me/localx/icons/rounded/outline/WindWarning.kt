    ...
    get() {
        ...
        _windWarning = Builder(name = "WindWarning", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.0f, 14.0f)
                curveTo(-2.251f, 13.706f, -2.249f, 0.293f, 7.0f, 0.0f)
                curveTo(16.251f, 0.294f, 16.249f, 13.707f, 7.0f, 14.0f)
                close()
                moveTo(7.0f, 2.0f)
                curveTo(0.392f, 2.21f, 0.394f, 11.791f, 7.0f, 12.0f)
                curveTo(13.608f, 11.79f, 13.606f, 2.209f, 7.0f, 2.0f)
                close()
                moveTo(20.0f, 9.0f)
                lineTo(17.0f, 9.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 0.0f, -2.0f)
