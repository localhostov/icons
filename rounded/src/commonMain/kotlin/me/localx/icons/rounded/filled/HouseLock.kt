...
public val Icons.Filled.HouseLock: ImageVector
    get() {
        if (_houseLock != null) {
            return _houseLock!!
        }
        _houseLock = Builder(name = "HouseLock", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-1.255f, 1.127f, -2.0f, 2.744f, -2.0f, 4.448f)
                verticalLineToRelative(2.0f)
                curveToRelative(0.0f, 1.54f, 0.588f, 2.941f, 1.544f, 4.004f)
                close()
            }
        }
        .build()
