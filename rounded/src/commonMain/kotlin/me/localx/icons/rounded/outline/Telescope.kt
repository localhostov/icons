    ...
    get() {
        ...
        _telescope = Builder(name = "Telescope", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.5f, -0.235f, 0.714f, -0.831f, 0.479f, -1.331f)
                close()
                moveTo(7.431f, 12.858f)
                curveToRelative(-0.431f, 0.185f, -0.905f, 0.189f, -1.339f, 0.015f)
                reflectiveCurveToRelative(-0.773f, -0.509f, -0.955f, -0.939f)
                curveToRelative(-0.371f, -0.881f, 0.041f, -1.903f, 0.917f, -2.279f)
                lineToRelative(13.255f, -5.648f)
                lineToRelative(1.486f, 3.158f)
                lineToRelative(-13.364f, 5.695f)
                close()
            }
        }
        .build()
