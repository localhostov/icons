        ...
        _exclamation = Builder(name = "Exclamation", defaultWidth = 24.0.dp, defaultHeight =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = NonZero) {
                    moveTo(12.0002f, 5.0001f)
                    curveTo(11.735f, 5.0001f, 11.4806f, 5.1055f, 11.2931f, 5.293f)
                    curveTo(11.1055f, 5.4805f, 11.0002f, 5.7349f, 11.0002f, 6.0001f)
                    verticalLineTo(14.0001f)
                    curveTo(11.0002f, 14.2653f, 11.1055f, 14.5197f, 11.2931f, 14.7072f)
                    curveTo(11.4806f, 14.8948f, 11.735f, 15.0001f, 12.0002f, 15.0001f)
                    curveTo(12.2654f, 15.0001f, 12.5198f, 14.8948f, 12.7073f, 14.7072f)
                    curveTo(12.8948f, 14.5197f, 13.0002f, 14.2653f, 13.0002f, 14.0001f)
                    verticalLineTo(6.0001f)
                    curveTo(13.0002f, 5.7349f, 12.8948f, 5.4805f, 12.7073f, 5.293f)
                    curveTo(12.5198f, 5.1055f, 12.2654f, 5.0001f, 12.0002f, 5.0001f)
                    close()
                }
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = NonZero) {
                    moveTo(13.0002f, 18.0001f)
                    curveTo(13.0002f, 17.4478f, 12.5525f, 17.0001f, 12.0002f, 17.0001f)
                    curveTo(11.4479f, 17.0001f, 11.0002f, 17.4478f, 11.0002f, 18.0001f)
                    curveTo(11.0002f, 18.5524f, 11.4479f, 19.0001f, 12.0002f, 19.0001f)
                    curveTo(12.5525f, 19.0001f, 13.0002f, 18.5524f, 13.0002f, 18.0001f)
                    close()
                }
            }
        }
