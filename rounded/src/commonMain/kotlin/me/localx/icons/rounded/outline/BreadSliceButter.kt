    ...
    get() {
        ...
        _breadSliceButter = Builder(name = "BreadSliceButter", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(21.035f, 8.185f)
                curveToRelative(-0.667f, 0.611f, -1.034f, 1.414f, -1.034f, 2.26f)
                verticalLineToRelative(7.555f)
                curveToRelative(0.0f, 1.654f, -1.346f, 3.0f, -3.0f, 3.0f)
                lineTo(7.0f, 21.0f)
                curveToRelative(-1.654f, 0.0f, -3.0f, -1.346f, -3.0f, -3.0f)
                verticalLineToRelative(-7.554f)
                curveToRelative(0.0f, -0.845f, -0.368f, -1.648f, -1.036f, -2.263f)
                curveToRelative(-0.75f, -0.691f, -1.087f, -1.67f, -0.923f, -2.686f)
                curveToRelative(0.256f, -1.588f, 1.787f, -2.498f, 4.201f, -2.498f)
                horizontalLineToRelative(12.606f)
                curveToRelative(1.544f, 0.0f, 2.882f, 1.074f, 3.111f, 2.498f)
                curveToRelative(0.164f, 1.017f, -0.173f, 1.996f, -0.925f, 2.688f)
                close()
            }
        }
        .build()
