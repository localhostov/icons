    ...
    get() {
        ...
        _cloudCode = Builder(name = "CloudCode", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(21.976f, 15.028f)
                curveToRelative(-0.259f, 2.788f, -2.761f, 4.972f, -5.698f, 4.972f)
                lineTo(5.0f, 20.0f)
                curveToRelative(-1.654f, 0.0f, -3.0f, -1.57f, -3.0f, -3.5f)
                curveToRelative(0.0f, -0.883f, 0.33f, -1.726f, 0.929f, -2.374f)
                curveToRelative(0.808f, -0.876f, 1.199f, -1.948f, 1.099f, -3.02f)
                curveToRelative(-0.061f, -0.656f, -0.022f, -1.328f, 0.116f, -1.994f)
                curveToRelative(0.515f, -2.498f, 2.544f, -4.501f, 5.05f, -4.986f)
                curveToRelative(0.43f, -0.083f, 0.859f, -0.123f, 1.283f, -0.123f)
                curveToRelative(2.386f, 0.0f, 4.598f, 1.279f, 5.751f, 3.421f)
                horizontalLineToRelative(0.0f)
                curveToRelative(0.474f, 0.88f, 1.268f, 1.567f, 2.237f, 1.938f)
                curveToRelative(2.295f, 0.879f, 3.738f, 3.209f, 3.511f, 5.667f)
                close()
                moveTo(10.587f, 16.748f)
