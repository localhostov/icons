    ...
    get() {
        ...
        _leave = Builder(name = "Leave", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(0.0f, 5.621f)
                curveTo(0.0f, 3.246f, 1.69f, 1.184f, 4.019f, 0.718f)
                lineTo(7.216f, 0.079f)
                curveToRelative(1.181f, -0.236f, 2.391f, 0.066f, 3.321f, 0.829f)
                curveToRelative(0.375f, 0.307f, 0.665f, 0.685f, 0.902f, 1.092f)
                ...
                close()
                moveTo(10.0f, 4.001f)
                curveToRelative(0.0f, -0.602f, -0.267f, -1.165f, -0.731f, -1.546f)
                curveToRelative(-0.362f, -0.297f, -0.808f, -0.454f, -1.266f, -0.454f)
                curveToRelative(-0.131f, 0.0f, -0.264f, 0.013f, -0.396f, 0.039f)
                lineToRelative(-3.196f, 0.639f)
                curveToRelative(-1.397f, 0.279f, -2.411f, 1.517f, -2.411f, 2.942f)
