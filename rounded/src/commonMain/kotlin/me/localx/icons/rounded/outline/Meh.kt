        ...
        _meh = Builder(name = "Meh", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(17.0f, 16.0f)
                    curveTo(17.0f, 15.7348f, 16.8946f, 15.4804f, 16.7071f, 15.2929f)
                    curveTo(16.5196f, 15.1054f, 16.2652f, 15.0f, 16.0f, 15.0f)
                    horizontalLineTo(8.0f)
                    curveTo(7.7348f, 15.0f, 7.4804f, 15.1054f, 7.2929f, 15.2929f)
                    curveTo(7.1054f, 15.4804f, 7.0f, 15.7348f, 7.0f, 16.0f)
                    curveTo(7.0f, 16.2652f, 7.1054f, 16.5196f, 7.2929f, 16.7071f)
                    curveTo(7.4804f, 16.8946f, 7.7348f, 17.0f, 8.0f, 17.0f)
                    horizontalLineTo(16.0f)
                    curveTo(16.2652f, 17.0f, 16.5196f, 16.8946f, 16.7071f, 16.7071f)
                    curveTo(16.8946f, 16.5196f, 17.0f, 16.2652f, 17.0f, 16.0f)
                    close()
                    moveTo(6.0f, 10.0f)
