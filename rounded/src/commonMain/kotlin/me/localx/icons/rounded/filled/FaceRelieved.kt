    ...
    get() {
        ...
        _faceRelieved = Builder(name = "FaceRelieved", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(11.971f, 0.0f)
                curveTo(5.354f, 0.0f, -0.029f, 5.383f, -0.029f, 12.0f)
                reflectiveCurveToRelative(5.383f, 12.0f, 12.0f, 12.0f)
                reflectiveCurveToRelative(12.0f, -5.383f, 12.0f, -12.0f)
                reflectiveCurveTo(18.588f, 0.0f, 11.971f, 0.0f)
                close()
                moveTo(13.996f, 5.777f)
                curveToRelative(0.124f, -0.539f, 0.661f, -0.878f, 1.198f, -0.752f)
                ...
                close()
                moveTo(5.188f, 7.377f)
                curveToRelative(0.91f, -1.143f, 2.307f, -2.065f, 3.559f, -2.352f)
                curveToRelative(0.541f, -0.127f, 1.075f, 0.214f, 1.198f, 0.752f)
                ...
                close()
                moveTo(5.235f, 11.646f)
                curveToRelative(-0.356f, -0.421f, -0.304f, -1.052f, 0.118f, -1.409f)
                curveToRelative(0.422f, -0.355f, 1.052f, -0.305f, 1.41f, 0.118f)
                curveToRelative(0.358f, 0.424f, 0.755f, 0.64f, 1.179f, 0.643f)
                horizontalLineToRelative(0.007f)
                curveToRelative(0.451f, 0.0f, 0.946f, -0.25f, 1.294f, -0.652f)
                curveToRelative(0.362f, -0.415f, 0.994f, -0.463f, 1.411f, -0.101f)
                curveToRelative(0.417f, 0.361f, 0.462f, 0.993f, 0.101f, 1.411f)
                curveToRelative(-0.729f, 0.841f, -1.777f, 1.342f, -2.807f, 1.342f)
                horizontalLineToRelative(-0.019f)
                curveToRelative(-0.711f, -0.005f, -1.756f, -0.242f, -2.694f, -1.352f)
                close()
                moveTo(17.665f, 16.747f)
                ...
                curveToRelative(0.367f, -0.411f, 1.0f, -0.448f, 1.411f, -0.081f)
                curveToRelative(0.048f, 0.042f, 2.021f, 1.747f, 4.335f, 1.747f)
                curveToRelative(2.331f, 0.0f, 4.316f, -1.73f, 4.336f, -1.747f)
                curveToRelative(0.414f, -0.366f, 1.045f, -0.328f, 1.411f, 0.084f)
                curveToRelative(0.366f, 0.412f, 0.331f, 1.042f, -0.081f, 1.409f)
                close()
                moveTo(18.755f, 11.656f)
                curveToRelative(-0.729f, 0.841f, -1.777f, 1.342f, -2.807f, 1.342f)
                horizontalLineToRelative(-0.019f)
                curveToRelative(-0.711f, -0.005f, -1.756f, -0.242f, -2.694f, -1.352f)
                curveToRelative(-0.356f, -0.421f, -0.304f, -1.052f, 0.118f, -1.409f)
                curveToRelative(0.422f, -0.355f, 1.053f, -0.305f, 1.41f, 0.118f)
                curveToRelative(0.358f, 0.424f, 0.755f, 0.64f, 1.179f, 0.643f)
                horizontalLineToRelative(0.007f)
                curveToRelative(0.451f, 0.0f, 0.946f, -0.25f, 1.294f, -0.652f)
                curveToRelative(0.361f, -0.415f, 0.994f, -0.463f, 1.411f, -0.101f)
                curveToRelative(0.417f, 0.361f, 0.462f, 0.993f, 0.101f, 1.411f)
                close()
            }
        }
