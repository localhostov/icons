...
public val Icons.Outline.CameraCctv: ImageVector
    get() {
        if (_cameraCctv != null) {
            return _cameraCctv!!
        }
        _cameraCctv = Builder(name = "CameraCctv", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(16.84f, 13.477f)
                curveToRelative(-0.521f, 0.148f, -1.066f, 0.082f, -1.527f, -0.18f)
                lineTo(5.011f, 7.291f)
                curveToRelative(-0.94f, -0.535f, -1.284f, -1.744f, -0.768f, -2.694f)
                lineToRelative(0.844f, -1.552f)
                curveToRelative(0.257f, -0.474f, 0.684f, -0.816f, 1.202f, -0.966f)
                curveToRelative(0.186f, -0.053f, 0.374f, -0.08f, 0.561f, -0.08f)
                curveToRelative(0.335f, 0.0f, 0.665f, 0.084f, 0.959f, 0.25f)
                lineToRelative(12.4f, 7.143f)
                lineToRelative(-0.135f, 0.105f)
                curveToRelative(-0.438f, 0.339f, -0.794f, 0.758f, -1.06f, 1.245f)
                lineToRelative(-0.966f, 1.77f)
                curveToRelative(-0.259f, 0.475f, -0.688f, 0.818f, -1.208f, 0.966f)
                close()
            }
        }
        .build()
