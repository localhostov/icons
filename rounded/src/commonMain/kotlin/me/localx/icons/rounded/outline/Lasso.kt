        ...
        _lasso = Builder(name = "Lasso", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(4.2902f, 14.688f)
                    curveTo(4.1978f, 14.5963f, 4.1244f, 14.4873f, 4.0744f, 14.3672f)
                    curveTo(4.0243f, 14.247f, 3.9986f, 14.1182f, 3.9986f, 13.988f)
                    curveTo(3.9986f, 13.8579f, 4.0243f, 13.729f, 4.0744f, 13.6088f)
                    curveTo(4.1244f, 13.4887f, 4.1978f, 13.3797f, 4.2902f, 13.288f)
                    curveTo(4.3818f, 13.1955f, 4.4908f, 13.122f, 4.6109f, 13.0719f)
                    curveTo(4.7311f, 13.0218f, 4.86f, 12.996f, 4.9902f, 12.996f)
                    curveTo(5.1203f, 12.996f, 5.2492f, 13.0218f, 5.3694f, 13.0719f)
                    curveTo(5.4896f, 13.122f, 5.5986f, 13.1955f, 5.6902f, 13.288f)
                    curveTo(6.1061f, 13.815f, 6.4576f, 14.3897f, 6.7372f, 15.0f)
                    curveTo(5.9098f, 15.0327f, 5.0828f, 14.9273f, 4.2902f, 14.688f)
                    close()
