    ...
    get() {
        ...
        _mandolin = Builder(name = "Mandolin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.602f, 0.0f, 1.169f, 0.153f, 1.664f, 0.422f)
                lineToRelative(5.422f, -5.422f)
                ...
                lineToRelative(-5.422f, 5.422f)
                curveToRelative(0.269f, 0.495f, 0.422f, 1.062f, 0.422f, 1.664f)
                close()
                moveTo(23.542f, 1.772f)
