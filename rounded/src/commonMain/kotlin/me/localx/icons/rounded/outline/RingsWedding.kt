    ...
    get() {
        ...
        _ringsWedding = Builder(name = "RingsWedding", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(10.553f, 4.895f)
                arcTo(1.0f, 1.0f, 0.0f, false, false, 11.9f, 4.447f)
                lineToRelative(1.0f, -2.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, true, false, -1.79f, -0.894f)
                lineToRelative(-1.0f, 2.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, false, 10.553f, 4.895f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(2.105f, 4.447f)
                arcTo(1.0f, 1.0f, 0.0f, true, false, 3.9f, 3.553f)
                lineToRelative(-1.0f, -2.0f)
