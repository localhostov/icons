        ...
        _meh = Builder(name = "Meh", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(16.2652f, 15.0f, 16.5196f, 15.1054f, 16.7071f, 15.2929f)
                    curveTo(16.8946f, 15.4804f, 17.0f, 15.7348f, 17.0f, 16.0f)
                    curveTo(17.0f, 16.2652f, 16.8946f, 16.5196f, 16.7071f, 16.7071f)
                    curveTo(16.5196f, 16.8946f, 16.2652f, 17.0f, 16.0f, 17.0f)
                    close()
                    moveTo(16.0f, 11.0f)
