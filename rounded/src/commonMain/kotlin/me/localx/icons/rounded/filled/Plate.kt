    ...
    get() {
        ...
        _plate = Builder(name = "Plate", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.63f, 15.908f, 23.373f, 15.9f, 24.0f, 0.0f)
                arcTo(12.013f, 12.013f, 0.0f, false, false, 12.0f, 0.0f)
                close()
                moveTo(12.0f, 21.0f)
                curveTo(0.077f, 20.548f, 0.08f, 3.451f, 12.0f, 3.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 0.0f, 2.0f)
                arcToRelative(7.008f, 7.008f, 0.0f, false, false, -7.0f, 7.0f)
                curveToRelative(0.294f, 9.251f, 13.707f, 9.249f, 14.0f, 0.0f)
