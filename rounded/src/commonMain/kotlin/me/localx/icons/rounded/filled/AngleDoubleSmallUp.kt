...
public val Icons.Filled.AngleDoubleSmallUp: ImageVector
    get() {
        ...
        _angleDoubleSmallUp = Builder(name = "AngleDoubleSmallUp", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.0f, 11.738f)
                curveToRelative(-0.254f, 0.0f, -0.508f, -0.096f, -0.702f, -0.289f)
                lineToRelative(-3.93f, -3.88f)
                curveToRelative(-0.738f, -0.737f, -2.003f, -0.733f, -2.731f, -0.004f)
                lineToRelative(-3.935f, 3.884f)
                curveToRelative(-0.393f, 0.388f, -1.024f, 0.385f, -1.414f, -0.009f)
                curveToRelative(-0.388f, -0.393f, -0.384f, -1.026f, 0.01f, -1.414f)
                lineToRelative(3.93f, -3.88f)
                curveToRelative(0.736f, -0.738f, 1.723f, -1.146f, 2.772f, -1.146f)
                reflectiveCurveToRelative(2.036f, 0.409f, 2.777f, 1.151f)
                lineToRelative(3.925f, 3.875f)
                curveToRelative(0.394f, 0.388f, 0.397f, 1.021f, 0.01f, 1.414f)
                curveToRelative(-0.196f, 0.198f, -0.454f, 0.297f, -0.712f, 0.297f)
                close()
            }
        }
        .build()
