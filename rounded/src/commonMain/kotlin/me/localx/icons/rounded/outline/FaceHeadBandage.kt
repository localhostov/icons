    ...
    get() {
        ...
        _faceHeadBandage = Builder(name = "FaceHeadBandage", defaultWidth = 512.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(1.57f, 0.79f, 3.16f, 1.71f, 4.68f, 2.8f)
                curveToRelative(-1.16f, 4.24f, -5.05f, 7.36f, -9.65f, 7.36f)
                close()
                moveTo(16.87f, 17.49f)
                curveToRelative(-0.18f, 0.33f, -0.52f, 0.51f, -0.87f, 0.51f)
                curveToRelative(-0.16f, 0.0f, -0.33f, -0.04f, -0.48f, -0.12f)
                curveToRelative(-0.02f, 0.0f, -1.61f, -0.88f, -3.51f, -0.88f)
                reflectiveCurveToRelative(-3.5f, 0.87f, -3.52f, 0.88f)
                curveToRelative(-0.48f, 0.26f, -1.09f, 0.09f, -1.36f, -0.39f)
