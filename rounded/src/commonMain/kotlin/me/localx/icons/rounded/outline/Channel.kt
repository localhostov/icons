...
public val Icons.Outline.Channel: ImageVector
    get() {
        if (_channel != null) {
            return _channel!!
        }
        _channel = Builder(name = "Channel", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.721f, -1.177f, 0.351f, -2.717f, -0.827f, -3.438f)
                curveToRelative(-1.177f, -0.721f, -2.717f, -0.351f, -3.438f, 0.826f)
                curveToRelative(-0.535f, 0.874f, -0.467f, 1.946f, 0.084f, 2.736f)
                curveToRelative(-0.607f, 0.991f, -1.304f, 2.131f, -1.753f, 2.863f)
                ...
                curveToRelative(-0.721f, -1.177f, -2.26f, -1.548f, -3.438f, -0.826f)
                curveToRelative(-1.177f, 0.721f, -1.547f, 2.26f, -0.826f, 3.438f)
                curveToRelative(0.535f, 0.874f, 1.521f, 1.3f, 2.474f, 1.169f)
                ...
                curveTo(1.119f, 9.5f, 0.0f, 10.619f, 0.0f, 12.0f)
