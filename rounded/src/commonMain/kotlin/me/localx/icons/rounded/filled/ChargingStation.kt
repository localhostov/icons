    ...
    get() {
        ...
        _chargingStation = Builder(name = "ChargingStation", defaultWidth = 512.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(5.008f, 5.008f, 0.0f, false, false, 4.582f, -3.0f)
                horizontalLineTo(18.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 4.0f, -4.0f)
                verticalLineTo(7.95f)
                arcTo(2.5f, 2.5f, 0.0f, false, false, 24.0f, 5.5f)
                verticalLineTo(3.0f)
                arcTo(1.0f, 1.0f, 0.0f, false, false, 23.0f, 2.0f)
                close()
                moveTo(10.732f, 11.49f)
                ...
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 0.1f, -0.234f)
                lineTo(7.148f, 5.476f)
                arcToRelative(1.0f, 1.0f, 0.0f, true, true, 1.7f, 1.048f)
                lineTo(7.328f, 9.0f)
                horizontalLineTo(9.4f)
                arcToRelative(1.6f, 1.6f, 0.0f, false, true, 1.336f, 2.49f)
                close()
            }
        }
        .build()
