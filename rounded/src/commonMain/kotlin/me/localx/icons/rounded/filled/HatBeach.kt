    ...
    get() {
        ...
        _hatBeach = Builder(name = "HatBeach", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(0.672f, -1.5f, 1.5f, -1.5f)
                close()
                moveTo(6.309f, 12.54f)
                curveToRelative(-0.823f, -0.558f, -1.309f, -1.488f, -1.309f, -2.482f)
                verticalLineToRelative(-0.789f)
                curveToRelative(0.0f, -3.715f, 2.779f, -6.983f, 6.484f, -7.25f)
                curveToRelative(2.133f, -0.154f, 4.085f, 0.655f, 5.465f, 2.035f)
                ...
                curveToRelative(-2.836f, 0.0f, -4.619f, -0.733f, -5.691f, -1.46f)
                close()
                moveTo(24.0f, 14.5f)
                ...
                curveToRelative(0.0f, 1.496f, 0.678f, 2.93f, 1.888f, 3.809f)
                curveToRelative(1.393f, 1.013f, 3.656f, 2.038f, 7.112f, 2.038f)
