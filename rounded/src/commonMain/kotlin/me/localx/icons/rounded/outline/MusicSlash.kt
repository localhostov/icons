    ...
    get() {
        ...
        _musicSlash = Builder(name = "MusicSlash", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.096f, 15.682f)
                curveToRelative(0.532f, -0.438f, 1.2f, -0.682f, 1.904f, -0.682f)
                curveToRelative(1.654f, 0.0f, 3.0f, 1.346f, 3.0f, 3.0f)
                curveToRelative(0.0f, 0.704f, -0.243f, 1.372f, -0.682f, 1.904f)
                lineToRelative(-4.223f, -4.223f)
                close()
                moveTo(9.0f, 13.0f)
