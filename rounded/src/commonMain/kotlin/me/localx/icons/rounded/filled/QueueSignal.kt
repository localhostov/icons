...
public val Icons.Filled.QueueSignal: ImageVector
    get() {
        ...
        _queueSignal = Builder(name = "QueueSignal", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineToRelative(-3.0f)
                curveToRelative(0.0f, -2.032f, 1.529f, -3.697f, 3.494f, -3.949f)
                curveToRelative(-0.927f, 1.056f, -1.494f, 2.436f, -1.494f, 3.949f)
                verticalLineToRelative(3.0f)
