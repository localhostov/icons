    ...
    get() {
        ...
        _scythe = Builder(name = "Scythe", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(21.974f, 2.759f)
                lineToRelative(-0.963f, 3.241f)
                horizontalLineToRelative(-11.269f)
                curveToRelative(-2.523f, 0.0f, -4.845f, 0.749f, -6.666f, 1.414f)
                curveToRelative(3.536f, -3.594f, 7.824f, -5.414f, 12.769f, -5.414f)
                horizontalLineToRelative(5.561f)
                curveToRelative(0.259f, 0.0f, 0.408f, 0.149f, 0.475f, 0.238f)
                reflectiveCurveToRelative(0.167f, 0.275f, 0.094f, 0.521f)
                close()
            }
        }
        .build()
