...
public val Icons.Filled.CompassNorth: ImageVector
    get() {
        ...
        _compassNorth = Builder(name = "CompassNorth", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.72f, 13.373f)
                curveToRelative(-0.626f, -1.447f, -3.286f, -6.256f, -3.383f, -6.429f)
                curveToRelative(-0.447f, -0.88f, -1.337f, -1.426f, -2.323f, -1.426f)
                horizontalLineToRelative(-0.008f)
                curveToRelative(-0.989f, 0.003f, -1.88f, 0.555f, -2.312f, 1.419f)
                curveToRelative(0.0f, 0.0f, -3.321f, 6.252f, -3.376f, 6.355f)
                curveToRelative(-0.01f, 0.019f, -0.021f, 0.039f, -0.028f, 0.058f)
