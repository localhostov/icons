    ...
    get() {
        ...
        _userMusic = Builder(name = "UserMusic", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.0f, 17.261f)
                verticalLineToRelative(-2.261f)
                curveToRelative(0.0f, -0.016f, 0.004f, -0.032f, 0.004f, -0.048f)
                curveToRelative(-1.208f, -0.604f, -2.565f, -0.952f, -4.004f, -0.952f)
                curveTo(4.038f, 14.0f, 0.0f, 18.038f, 0.0f, 23.0f)
                curveToRelative(0.0f, 0.552f, 0.448f, 1.0f, 1.0f, 1.0f)
                horizontalLineToRelative(9.76f)
                curveToRelative(-0.479f, -0.715f, -0.76f, -1.573f, -0.76f, -2.496f)
