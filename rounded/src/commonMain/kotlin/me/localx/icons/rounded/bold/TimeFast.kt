    ...
    get() {
        ...
        _timeFast = Builder(name = "TimeFast", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveToRelative(14.5f, 23.722f)
                arcToRelative(1.5f, 1.5f, 0.0f, false, true, -0.354f, -2.958f)
                arcToRelative(9.022f, 9.022f, 0.0f, true, false, -10.303f, -12.622f)
                arcToRelative(1.5f, 1.5f, 0.0f, false, true, -2.711f, -1.284f)
                arcToRelative(12.023f, 12.023f, 0.0f, true, true, 13.723f, 16.821f)
                arcToRelative(1.513f, 1.513f, 0.0f, false, true, -0.355f, 0.043f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
