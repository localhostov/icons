    ...
    get() {
        ...
        _faceSmirking = Builder(name = "FaceSmirking", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.763f, 14.532f)
                curveToRelative(0.447f, 0.697f, 0.245f, 1.625f, -0.453f, 2.073f)
                curveToRelative(-1.423f, 0.913f, -2.914f, 1.396f, -4.31f, 1.396f)
                horizontalLineToRelative(-3.5f)
                curveToRelative(-0.829f, 0.0f, -1.5f, -0.671f, -1.5f, -1.5f)
                reflectiveCurveToRelative(0.671f, -1.5f, 1.5f, -1.5f)
                horizontalLineToRelative(3.5f)
                curveToRelative(0.821f, 0.0f, 1.751f, -0.318f, 2.69f, -0.921f)
                curveToRelative(0.696f, -0.447f, 1.625f, -0.245f, 2.073f, 0.453f)
                close()
            }
        }
        .build()
