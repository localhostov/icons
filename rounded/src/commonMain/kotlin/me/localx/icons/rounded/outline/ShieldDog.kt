    ...
    get() {
        ...
        _shieldDog = Builder(name = "ShieldDog", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 6.563f, 7.005f, 10.577f, 9.153f, 11.65f)
                curveToRelative(0.0f, 0.0f, 0.479f, 0.307f, 0.85f, 0.307f)
                curveToRelative(0.399f, 0.0f, 0.964f, -0.311f, 1.061f, -0.352f)
                curveToRelative(2.422f, -1.026f, 8.937f, -4.457f, 8.937f, -11.605f)
                verticalLineToRelative(-5.171f)
                curveToRelative(0.0f, -2.159f, -1.377f, -4.066f, -3.427f, -4.746f)
                close()
                moveTo(19.998f, 12.043f)
                curveToRelative(0.0f, 6.181f, -6.088f, 9.11f, -7.954f, 9.861f)
                curveToRelative(-1.888f, -0.944f, -8.047f, -4.445f, -8.047f, -9.861f)
                verticalLineToRelative(-5.171f)
                curveToRelative(0.0f, -1.296f, 0.826f, -2.44f, 2.056f, -2.848f)
                ...
                reflectiveCurveToRelative(0.023f, 0.093f, -0.041f, 0.333f)
                close()
            }
        }
        .build()
