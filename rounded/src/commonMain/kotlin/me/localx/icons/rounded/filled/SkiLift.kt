...
public val Icons.Filled.SkiLift: ImageVector
    get() {
        if (_skiLift != null) {
            return _skiLift!!
        }
        _skiLift = Builder(name = "SkiLift", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(0.7f, 1.672f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, -0.508f, 1.293f)
                lineToRelative(-1.749f, 0.835f)
                arcTo(1.031f, 1.031f, 0.0f, false, false, 8.1f, 12.546f)
