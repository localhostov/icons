...
public val Icons.Outline.ShoppingBasket: ImageVector
    get() {
        ...
        _shoppingBasket = Builder(name = "ShoppingBasket", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(22.021f, 11.142f)
                lineToRelative(-1.061f, 7.424f)
                curveToRelative(-0.28f, 1.958f, -1.982f, 3.435f, -3.96f, 3.435f)
                lineTo(7.031f, 22.001f)
                curveToRelative(-1.979f, 0.0f, -3.681f, -1.477f, -3.96f, -3.435f)
                lineToRelative(-1.061f, -7.424f)
                curveToRelative(-0.042f, -0.291f, 0.042f, -0.574f, 0.234f, -0.797f)
                curveToRelative(0.193f, -0.223f, 0.461f, -0.345f, 0.755f, -0.345f)
                lineTo(21.03f, 10.0f)
                curveToRelative(0.294f, 0.0f, 0.562f, 0.122f, 0.756f, 0.345f)
                curveToRelative(0.192f, 0.223f, 0.276f, 0.506f, 0.234f, 0.797f)
                close()
                moveTo(13.0f, 13.0f)
