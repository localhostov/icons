    ...
    get() {
        ...
        _baguette = Builder(name = "Baguette", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.456f, -1.208f, 1.143f, -2.464f, 1.984f, -3.674f)
                lineToRelative(2.728f, 2.728f)
                curveToRelative(0.195f, 0.195f, 0.451f, 0.293f, 0.707f, 0.293f)
                reflectiveCurveToRelative(0.512f, -0.098f, 0.707f, -0.293f)
                curveToRelative(0.391f, -0.391f, 0.391f, -1.023f, 0.0f, -1.414f)
                lineToRelative(-2.912f, -2.912f)
                curveToRelative(0.365f, -0.43f, 0.744f, -0.85f, 1.142f, -1.248f)
                ...
                lineToRelative(-2.965f, -2.965f)
                lineToRelative(1.391f, -1.391f)
                curveToRelative(0.398f, -0.398f, 0.818f, -0.777f, 1.248f, -1.141f)
                lineToRelative(2.912f, 2.912f)
                curveToRelative(0.195f, 0.195f, 0.451f, 0.293f, 0.707f, 0.293f)
                reflectiveCurveToRelative(0.512f, -0.098f, 0.707f, -0.293f)
                curveToRelative(0.391f, -0.391f, 0.391f, -1.023f, 0.0f, -1.414f)
                lineToRelative(-2.728f, -2.728f)
                curveToRelative(1.209f, -0.841f, 2.466f, -1.529f, 3.673f, -1.984f)
