...
public val Icons.Outline.CircleMicrophoneLines: ImageVector
    get() {
        if (_circleMicrophoneLines != null) {
            return _circleMicrophoneLines!!
        }
        _circleMicrophoneLines = Builder(name = "CircleMicrophoneLines", defaultWidth = 24.0.dp,
