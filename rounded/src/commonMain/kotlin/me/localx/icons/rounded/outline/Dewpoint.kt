...
public val Icons.Outline.Dewpoint: ImageVector
    get() {
        if (_dewpoint != null) {
            return _dewpoint!!
        }
        _dewpoint = Builder(name = "Dewpoint", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.006f, 2.0f)
                arcToRelative(2.312f, 2.312f, 0.0f, false, false, -1.752f, 0.8f)
                curveTo(8.161f, 2.9f, 2.0f, 9.459f, 2.0f, 14.0f)
                curveToRelative(-0.115f, 7.009f, 8.783f, 10.694f, 13.657f, 5.657f)
                curveToRelative(6.218f, -6.007f, -1.944f, -14.6f, -3.866f, -16.819f)
                arcTo(2.342f, 2.342f, 0.0f, false, false, 10.007f, 2.0f)
                close()
                moveTo(21.0f, 6.0f)
