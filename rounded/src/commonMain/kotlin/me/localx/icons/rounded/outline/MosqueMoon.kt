...
public val Icons.Outline.MosqueMoon: ImageVector
    get() {
        if (_mosqueMoon != null) {
            return _mosqueMoon!!
        }
        _mosqueMoon = Builder(name = "MosqueMoon", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(4.0f, 17.61f)
                curveToRelative(0.0f, -3.054f, 2.824f, -4.48f, 5.316f, -5.738f)
                curveToRelative(1.039f, -0.524f, 2.003f, -1.011f, 2.684f, -1.597f)
                curveToRelative(0.681f, 0.586f, 1.645f, 1.072f, 2.684f, 1.597f)
                curveToRelative(2.492f, 1.258f, 5.316f, 2.684f, 5.316f, 5.738f)
                curveToRelative(0.0f, 1.457f, -1.171f, 3.169f, -2.987f, 4.39f)
                lineTo(6.987f, 22.0f)
                curveToRelative(-1.816f, -1.221f, -2.987f, -2.932f, -2.987f, -4.39f)
                close()
            }
        }
        .build()
