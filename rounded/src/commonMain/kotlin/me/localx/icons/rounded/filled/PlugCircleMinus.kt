...
public val Icons.Filled.PlugCircleMinus: ImageVector
    get() {
        ...
        _plugCircleMinus = Builder(name = "PlugCircleMinus", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(10.0f, 18.0f)
                curveToRelative(0.0f, -4.079f, 3.055f, -7.438f, 7.0f, -7.931f)
                ...
                curveToRelative(0.0f, 4.024f, 3.062f, 7.354f, 7.008f, 7.839f)
                curveToRelative(-0.002f, 0.247f, -0.008f, 4.061f, -0.008f, 4.061f)
                curveToRelative(0.0f, 0.553f, 0.447f, 1.0f, 1.0f, 1.0f)
                reflectiveCurveToRelative(1.0f, -0.447f, 1.0f, -1.0f)
