        ...
        _headphones = Builder(name = "Headphones", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(6.163f, 22.0003f, 6.7989f, 21.7369f, 7.2678f, 21.268f)
                    curveTo(7.7366f, 20.7992f, 8.0f, 20.1633f, 8.0f, 19.5003f)
                    verticalLineTo(13.5003f)
                    curveTo(7.9999f, 12.9241f, 7.8008f, 12.3657f, 7.4363f, 11.9194f)
                    curveTo(7.0719f, 11.4732f, 6.5645f, 11.1665f, 6.0f, 11.0513f)
                    verticalLineTo(9.9943f)
                    ...
                    verticalLineTo(11.0513f)
                    curveTo(17.4355f, 11.1665f, 16.9281f, 11.4732f, 16.5637f, 11.9194f)
                    curveTo(16.1992f, 12.3657f, 16.0001f, 12.9241f, 16.0f, 13.5003f)
                    verticalLineTo(19.5003f)
                    curveTo(16.0f, 20.1633f, 16.2634f, 20.7992f, 16.7322f, 21.268f)
                    curveTo(17.2011f, 21.7369f, 17.837f, 22.0003f, 18.5f, 22.0003f)
