...
public val Icons.Bold.SaxHot: ImageVector
    get() {
        if (_saxHot != null) {
            return _saxHot!!
        }
        _saxHot = Builder(name = "SaxHot", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.789f, -0.269f, -1.637f, 0.152f, -1.904f, 0.936f)
                ...
                curveToRelative(-0.79f, -0.268f, -1.637f, 0.152f, -1.904f, 0.936f)
                curveToRelative(-0.268f, 0.784f, 0.151f, 1.637f, 0.936f, 1.904f)
                ...
                curveToRelative(-1.297f, 0.479f, -2.685f, 0.346f, -3.909f, -0.376f)
                ...
                close()
                moveTo(1.025f, 5.936f)
                curveToRelative(0.223f, -0.987f, 0.817f, -2.063f, 1.292f, -2.677f)
                curveToRelative(0.326f, -0.422f, 0.992f, -0.308f, 1.183f, 0.189f)
                curveToRelative(0.178f, 0.46f, 0.0f, 1.581f, 1.0f, 1.581f)
                curveToRelative(0.964f, 0.0f, 0.393f, -2.69f, 1.312f, -4.511f)
                curveToRelative(0.303f, -0.6f, 1.033f, -0.709f, 1.551f, -0.281f)
                curveToRelative(1.677f, 1.384f, 4.118f, 3.382f, 4.617f, 5.737f)
                curveToRelative(0.118f, 0.558f, -0.307f, 1.025f, -0.877f, 1.025f)
                lineTo(1.896f, 6.999f)
                curveToRelative(-0.598f, 0.0f, -1.003f, -0.481f, -0.871f, -1.064f)
                close()
            }
        }
        .build()
