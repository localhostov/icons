...
public val Icons.Outline.PenSlash: ImageVector
    get() {
        if (_penSlash != null) {
            return _penSlash!!
        }
        _penSlash = Builder(name = "PenSlash", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-5.049f, 5.05f)
                curveToRelative(-0.603f, 0.603f, -0.935f, 1.404f, -0.935f, 2.256f)
                verticalLineToRelative(1.039f)
                horizontalLineToRelative(1.039f)
                curveToRelative(0.853f, 0.0f, 1.653f, -0.332f, 2.255f, -0.935f)
                lineToRelative(4.942f, -4.941f)
                curveToRelative(0.391f, -0.391f, 1.023f, -0.391f, 1.414f, 0.0f)
                close()
