    ...
    get() {
        ...
        _modeLandscape = Builder(name = "ModeLandscape", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(22.5f, 15.5f)
                arcTo(1.5f, 1.5f, 0.0f, false, false, 21.0f, 17.0f)
                ...
                verticalLineTo(17.0f)
                arcTo(1.5f, 1.5f, 0.0f, false, false, 22.5f, 15.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(1.5f, 8.5f)
                arcTo(1.5f, 1.5f, 0.0f, false, false, 3.0f, 7.0f)
                verticalLineTo(5.5f)
                arcTo(2.5f, 2.5f, 0.0f, false, true, 5.5f, 3.0f)
                horizontalLineTo(7.0f)
                arcTo(1.5f, 1.5f, 0.0f, false, false, 7.0f, 0.0f)
                horizontalLineTo(5.5f)
                arcTo(5.506f, 5.506f, 0.0f, false, false, 0.0f, 5.5f)
                verticalLineTo(7.0f)
                arcTo(1.5f, 1.5f, 0.0f, false, false, 1.5f, 8.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
