...
public val Icons.Bold.Add: ImageVector
    get() {
        if (_add != null) {
            return _add!!
        }
        _add = Builder(name = "Add", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(17.0f, 12.0f)
                    curveTo(17.0f, 12.3978f, 16.842f, 12.7794f, 16.5607f, 13.0607f)
                    curveTo(16.2794f, 13.342f, 15.8978f, 13.5f, 15.5f, 13.5f)
                    horizontalLineTo(13.5f)
                    verticalLineTo(15.5f)
                    curveTo(13.5f, 15.8978f, 13.342f, 16.2794f, 13.0607f, 16.5607f)
                    curveTo(12.7794f, 16.842f, 12.3978f, 17.0f, 12.0f, 17.0f)
                    curveTo(11.6022f, 17.0f, 11.2206f, 16.842f, 10.9393f, 16.5607f)
                    curveTo(10.658f, 16.2794f, 10.5f, 15.8978f, 10.5f, 15.5f)
                    verticalLineTo(13.5f)
                    horizontalLineTo(8.5f)
                    curveTo(8.1022f, 13.5f, 7.7207f, 13.342f, 7.4393f, 13.0607f)
                    curveTo(7.158f, 12.7794f, 7.0f, 12.3978f, 7.0f, 12.0f)
                    curveTo(7.0f, 11.6022f, 7.158f, 11.2206f, 7.4393f, 10.9393f)
                    curveTo(7.7207f, 10.658f, 8.1022f, 10.5f, 8.5f, 10.5f)
                    horizontalLineTo(10.5f)
                    verticalLineTo(8.5f)
                    curveTo(10.5f, 8.1022f, 10.658f, 7.7206f, 10.9393f, 7.4393f)
                    curveTo(11.2206f, 7.158f, 11.6022f, 7.0f, 12.0f, 7.0f)
                    curveTo(12.3978f, 7.0f, 12.7794f, 7.158f, 13.0607f, 7.4393f)
                    curveTo(13.342f, 7.7206f, 13.5f, 8.1022f, 13.5f, 8.5f)
                    verticalLineTo(10.5f)
                    horizontalLineTo(15.5f)
                    curveTo(15.8978f, 10.5f, 16.2794f, 10.658f, 16.5607f, 10.9393f)
                    curveTo(16.842f, 11.2206f, 17.0f, 11.6022f, 17.0f, 12.0f)
                    close()
                }
            }
        }
