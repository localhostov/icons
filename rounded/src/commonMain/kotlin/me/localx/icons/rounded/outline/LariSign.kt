    ...
    get() {
        ...
        _lariSign = Builder(name = "LariSign", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-2.83f, -1.99f, -4.68f, -5.28f, -4.68f, -9.0f)
                curveTo(1.0f, 7.97f, 4.39f, 3.72f, 9.0f, 2.42f)
                verticalLineTo(1.0f)
                curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f)
                ...
                curveToRelative(4.61f, 1.31f, 8.0f, 5.56f, 8.0f, 10.58f)
                curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f)
                reflectiveCurveToRelative(-1.0f, -0.45f, -1.0f, -1.0f)
                curveToRelative(0.0f, -3.91f, -2.51f, -7.25f, -6.0f, -8.49f)
                ...
                curveToRelative(-3.49f, 1.24f, -6.0f, 4.57f, -6.0f, 8.49f)
