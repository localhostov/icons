...
public val Icons.Bold.PawHeart: ImageVector
    get() {
        if (_pawHeart != null) {
            return _pawHeart!!
        }
        _pawHeart = Builder(name = "PawHeart", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(24.0f, 7.789f)
                curveToRelative(0.0f, 4.885f, -5.546f, 11.17f, -9.273f, 14.203f)
                curveToRelative(-0.82f, 0.667f, -1.824f, 1.001f, -2.827f, 1.001f)
                curveToRelative(-1.009f, 0.0f, -2.018f, -0.338f, -2.839f, -1.013f)
                curveTo(5.558f, 19.099f, 0.0f, 12.699f, 0.0f, 7.79f)
                curveTo(0.0f, 4.046f, 3.033f, 1.0f, 6.762f, 1.0f)
                curveToRelative(2.048f, 0.0f, 3.948f, 0.91f, 5.238f, 2.503f)
                curveToRelative(1.291f, -1.593f, 3.19f, -2.503f, 5.238f, -2.503f)
                curveToRelative(3.729f, 0.0f, 6.762f, 3.046f, 6.762f, 6.79f)
                close()
                moveTo(22.0f, 7.789f)
                curveToRelative(0.0f, -2.641f, -2.136f, -4.79f, -4.762f, -4.79f)
                curveToRelative(-1.478f, 0.0f, -2.847f, 0.675f, -3.757f, 1.854f)
                curveToRelative(-0.715f, 0.928f, -2.247f, 0.928f, -2.963f, 0.0f)
                curveToRelative(-0.91f, -1.178f, -2.279f, -1.853f, -3.756f, -1.853f)
                curveToRelative(-2.625f, 0.0f, -4.762f, 2.148f, -4.762f, 4.79f)
                curveToRelative(0.0f, 3.996f, 4.872f, 9.801f, 8.331f, 12.646f)
                curveToRelative(0.919f, 0.756f, 2.208f, 0.758f, 3.134f, 0.005f)
                curveToRelative(4.138f, -3.366f, 8.535f, -8.944f, 8.535f, -12.651f)
                close()
            }
        }
        .build()
