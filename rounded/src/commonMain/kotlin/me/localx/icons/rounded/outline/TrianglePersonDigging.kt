    ...
    get() {
        ...
        _trianglePersonDigging = Builder(name = "TrianglePersonDigging", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(8.002f, 5.455f)
                lineToRelative(-0.508f, 0.733f)
                curveToRelative(-0.376f, 0.543f, 0.013f, 1.285f, 0.673f, 1.285f)
                horizontalLineToRelative(3.761f)
                curveToRelative(0.735f, 0.0f, 1.214f, -0.774f, 0.885f, -1.432f)
                lineToRelative(-1.558f, -3.116f)
                curveToRelative(-0.277f, -0.553f, -1.043f, -0.612f, -1.4f, -0.107f)
                lineToRelative(-0.884f, 1.252f)
                lineToRelative(-5.26f, -3.629f)
                ...
                lineToRelative(0.048f, 0.152f)
                curveToRelative(0.05f, 0.158f, 0.153f, 0.293f, 0.291f, 0.384f)
                curveToRelative(0.55f, 0.362f, 1.258f, -0.141f, 1.097f, -0.779f)
                ...
                lineToRelative(-1.146f, 3.194f)
                curveToRelative(-0.107f, 0.298f, -0.389f, 0.497f, -0.706f, 0.497f)
                horizontalLineToRelative(-0.041f)
                curveToRelative(-0.519f, 0.0f, -0.881f, -0.515f, -0.706f, -1.003f)
                lineToRelative(1.286f, -3.585f)
                close()
