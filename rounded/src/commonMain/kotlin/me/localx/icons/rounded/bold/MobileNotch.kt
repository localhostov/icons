    ...
    get() {
        ...
        _mobileNotch = Builder(name = "MobileNotch", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(7.0f, 5.5f)
                curveToRelative(0.0f, -1.079f, 0.688f, -2.001f, 1.648f, -2.35f)
                lineToRelative(0.511f, 1.021f)
                curveToRelative(0.254f, 0.508f, 0.773f, 0.829f, 1.342f, 0.829f)
                horizontalLineToRelative(3.0f)
                curveToRelative(0.568f, 0.0f, 1.087f, -0.321f, 1.342f, -0.829f)
                lineToRelative(0.511f, -1.021f)
                curveToRelative(0.96f, 0.349f, 1.648f, 1.271f, 1.648f, 2.35f)
                verticalLineToRelative(13.0f)
                close()
                moveTo(13.0f, 19.0f)
