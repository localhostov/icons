    ...
    get() {
        ...
        _tram = Builder(name = "Tram", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(20.0f, 2.545f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, 0.18f, -0.016f)
                lineToRelative(3.0f, -0.545f)
                arcTo(1.0f, 1.0f, 0.0f, false, false, 22.821f, 0.016f)
                lineToRelative(-3.0f, 0.546f)
                arcTo(1.0f, 1.0f, 0.0f, false, false, 20.0f, 2.545f)
                close()
                moveTo(1.0f, 6.0f)
                arcToRelative(1.012f, 1.012f, 0.0f, false, false, 0.18f, -0.016f)
                lineToRelative(4.0f, -0.727f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, false, -0.358f, -1.968f)
                lineToRelative(-4.0f, 0.727f)
