    ...
    get() {
        ...
        _glassEmpty = Builder(name = "GlassEmpty", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(-0.852f, 1.445f, -0.784f, 2.279f)
                lineToRelative(1.329f, 16.164f)
                curveToRelative(0.212f, 2.574f, 2.401f, 4.59f, 4.983f, 4.59f)
                horizontalLineToRelative(9.263f)
                ...
                close()
                moveTo(20.996f, 3.088f)
                lineToRelative(-1.422f, 16.175f)
                curveToRelative(-0.138f, 1.561f, -1.422f, 2.737f, -2.988f, 2.737f)
                lineTo(7.323f, 22.0f)
                curveToRelative(-1.549f, 0.0f, -2.863f, -1.21f, -2.99f, -2.754f)
                lineTo(3.003f, 3.082f)
                curveToRelative(-0.023f, -0.282f, 0.07f, -0.552f, 0.261f, -0.76f)
                reflectiveCurveToRelative(0.453f, -0.322f, 0.735f, -0.322f)
