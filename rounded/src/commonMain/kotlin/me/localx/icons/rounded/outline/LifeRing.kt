    ...
    get() {
        ...
        _lifeRing = Builder(name = "LifeRing", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(21.155f, 19.741f)
                arcToRelative(11.954f, 11.954f, 0.0f, false, false, 0.0f, -15.482f)
                lineToRelative(0.86f, -0.86f)
                arcTo(1.0f, 1.0f, 0.0f, false, false, 20.6f, 1.985f)
                lineToRelative(-0.86f, 0.86f)
                arcToRelative(11.954f, 11.954f, 0.0f, false, false, -15.482f, 0.0f)
                lineToRelative(-0.86f, -0.86f)
                arcTo(1.0f, 1.0f, 0.0f, false, false, 1.985f, 3.4f)
                lineToRelative(0.86f, 0.86f)
                arcToRelative(11.954f, 11.954f, 0.0f, false, false, 0.0f, 15.482f)
                lineToRelative(-0.86f, 0.86f)
                arcTo(1.0f, 1.0f, 0.0f, true, false, 3.4f, 22.015f)
                lineToRelative(0.86f, -0.86f)
                arcToRelative(11.954f, 11.954f, 0.0f, false, false, 15.482f, 0.0f)
                lineToRelative(0.86f, 0.86f)
                arcTo(1.0f, 1.0f, 0.0f, false, false, 22.015f, 20.6f)
                close()
                moveTo(22.0f, 12.0f)
