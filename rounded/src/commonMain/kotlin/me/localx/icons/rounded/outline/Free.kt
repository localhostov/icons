    ...
    get() {
        ...
        _free = Builder(name = "Free", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineToRelative(-0.601f)
                close()
                moveTo(12.5f, 10.448f)
                curveToRelative(-0.028f, -1.37f, -1.187f, -2.447f, -2.556f, -2.447f)
                ...
                curveToRelative(0.657f, -0.462f, 1.084f, -1.229f, 1.066f, -2.097f)
                close()
                moveTo(10.001f, 11.401f)
