...
public val Icons.Outline.RevenueAlt: ImageVector
    get() {
        if (_revenueAlt != null) {
            return _revenueAlt!!
        }
        _revenueAlt = Builder(name = "RevenueAlt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.479f, -0.278f, 1.09f, -0.113f, 1.366f, 0.365f)
                ...
                curveToRelative(1.067f, 0.0f, 2.063f, 0.574f, 2.598f, 1.499f)
                curveToRelative(0.277f, 0.478f, 0.113f, 1.089f, -0.364f, 1.366f)
                curveToRelative(-0.48f, 0.276f, -1.091f, 0.112f, -1.366f, -0.365f)
                curveToRelative(-0.179f, -0.308f, -0.511f, -0.5f, -0.867f, -0.5f)
                horizontalLineToRelative(-2.268f)
                curveToRelative(-0.552f, 0.0f, -1.0f, 0.448f, -1.0f, 1.0f)
                curveToRelative(0.0f, 0.378f, 0.271f, 0.698f, 0.644f, 0.76f)
                ...
                reflectiveCurveToRelative(1.023f, 0.391f, 1.414f, 0.0f)
                close()
                moveTo(7.707f, 7.879f)
                lineToRelative(-2.293f, -2.293f)
                curveToRelative(-0.779f, -0.78f, -2.049f, -0.78f, -2.828f, 0.0f)
                lineTo(0.293f, 7.879f)
                curveToRelative(-0.391f, 0.391f, -0.391f, 1.023f, 0.0f, 1.414f)
                reflectiveCurveToRelative(1.023f, 0.391f, 1.414f, 0.0f)
                lineToRelative(1.293f, -1.293f)
