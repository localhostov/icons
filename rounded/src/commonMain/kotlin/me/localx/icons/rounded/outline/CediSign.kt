...
public val Icons.Outline.CediSign: ImageVector
    get() {
        if (_cediSign != null) {
            return _cediSign!!
        }
        _cediSign = Builder(name = "CediSign", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 4.49f, 3.56f, 8.16f, 8.0f, 8.35f)
                verticalLineToRelative(1.01f)
                curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f)
                reflectiveCurveToRelative(1.0f, -0.45f, 1.0f, -1.0f)
                ...
                moveTo(5.0f, 13.63f)
                verticalLineToRelative(-3.27f)
                curveToRelative(0.0f, -3.39f, 2.66f, -6.16f, 6.0f, -6.35f)
                verticalLineToRelative(15.98f)
                curveToRelative(-3.34f, -0.19f, -6.0f, -2.97f, -6.0f, -6.35f)
                close()
            }
        }
        .build()
