    ...
    get() {
        ...
        _shieldCat = Builder(name = "ShieldCat", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveToRelative(17.002f, 7.335f)
                curveToRelative(-0.002f, -0.549f, -0.333f, -1.034f, -0.845f, -1.235f)
                curveToRelative(-0.513f, -0.2f, -1.086f, -0.072f, -1.462f, 0.331f)
                lineToRelative(-0.868f, 0.928f)
                curveToRelative(-1.172f, -0.471f, -2.482f, -0.472f, -3.654f, 0.0f)
                lineToRelative(-0.868f, -0.928f)
                curveToRelative(-0.376f, -0.402f, -0.948f, -0.531f, -1.462f, -0.331f)
                curveToRelative(-0.512f, 0.201f, -0.843f, 0.686f, -0.845f, 1.237f)
                curveToRelative(-0.005f, 2.579f, 0.002f, 4.664f, 0.002f, 4.664f)
                curveToRelative(0.0f, 2.757f, 2.243f, 5.0f, 5.0f, 5.0f)
                reflectiveCurveToRelative(5.0f, -2.243f, 5.0f, -5.0f)
                curveToRelative(0.0f, 0.0f, 0.007f, -2.089f, 0.002f, -4.665f)
                close()
                moveTo(15.0f, 12.0f)
                ...
                curveToRelative(0.323f, 0.344f, 0.841f, 0.417f, 1.246f, 0.174f)
                curveToRelative(0.969f, -0.583f, 2.102f, -0.583f, 3.07f, 0.0f)
                curveToRelative(0.405f, 0.244f, 0.923f, 0.171f, 1.246f, -0.174f)
                lineToRelative(0.224f, -0.239f)
                curveToRelative(0.002f, 1.267f, -0.005f, 2.95f, -0.005f, 2.974f)
                close()
                moveTo(13.0f, 12.618f)
                ...
                curveToRelative(0.0f, 0.0f, 0.523f, 0.307f, 0.85f, 0.307f)
