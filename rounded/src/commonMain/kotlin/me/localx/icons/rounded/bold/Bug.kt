    ...
    get() {
        ...
        _bug = Builder(name = "Bug", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(21.542f, 7.0f)
                arcTo(2.457f, 2.457f, 0.0f, false, false, 24.0f, 4.542f)
                verticalLineTo(1.5f)
                arcTo(1.5f, 1.5f, 0.0f, false, false, 22.5f, 0.0f)
                horizontalLineToRelative(0.0f)
                arcTo(1.5f, 1.5f, 0.0f, false, false, 21.0f, 1.5f)
                verticalLineTo(4.0f)
                ...
                arcTo(2.459f, 2.459f, 0.0f, false, false, 2.458f, 7.0f)
                horizontalLineToRelative(2.8f)
                lineTo(4.24f, 11.0f)
                horizontalLineTo(1.5f)
                arcTo(1.5f, 1.5f, 0.0f, false, false, 0.0f, 12.5f)
                ...
                arcTo(1.5f, 1.5f, 0.0f, false, false, 24.0f, 12.5f)
                horizontalLineToRelative(0.0f)
                arcTo(1.5f, 1.5f, 0.0f, false, false, 22.5f, 11.0f)
