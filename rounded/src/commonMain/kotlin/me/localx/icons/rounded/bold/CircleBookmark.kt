...
public val Icons.Bold.CircleBookmark: ImageVector
    get() {
        ...
        _circleBookmark = Builder(name = "CircleBookmark", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 0.648f, -0.783f, 0.972f, -1.241f, 0.514f)
                lineToRelative(-2.759f, -2.759f)
                lineToRelative(-2.759f, 2.759f)
                curveToRelative(-0.458f, 0.458f, -1.241f, 0.134f, -1.241f, -0.514f)
                verticalLineToRelative(-7.245f)
