    ...
    get() {
        ...
        _clipboardQuestion = Builder(name = "ClipboardQuestion", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.126f, -0.49f, -0.54f, -0.903f, -1.029f, -1.03f)
                curveToRelative(-0.484f, -0.126f, -0.957f, -0.034f, -1.333f, 0.258f)
                curveToRelative(-0.371f, 0.287f, -0.583f, 0.719f, -0.583f, 1.187f)
                curveToRelative(0.0f, 0.552f, -0.448f, 1.0f, -1.0f, 1.0f)
                reflectiveCurveToRelative(-1.0f, -0.448f, -1.0f, -1.0f)
                curveToRelative(0.0f, -1.091f, 0.495f, -2.1f, 1.359f, -2.769f)
                curveToRelative(0.863f, -0.669f, 1.979f, -0.892f, 3.058f, -0.613f)
                curveToRelative(1.19f, 0.307f, 2.158f, 1.275f, 2.465f, 2.466f)
