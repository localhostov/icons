    ...
    get() {
        ...
        _clawMarks = Builder(name = "ClawMarks", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveToRelative(23.887f, 23.061f)
                ...
                close()
                moveTo(22.937f, 12.832f)
                curveToRelative(0.555f, 0.479f, 1.355f, -0.192f, 0.957f, -0.808f)
                curveTo(19.841f, 5.753f, 15.033f, 2.029f, 11.959f, 0.102f)
                curveToRelative(-0.618f, -0.388f, -1.266f, 0.408f, -0.789f, 0.96f)
                curveToRelative(3.83f, 4.438f, 7.33f, 7.938f, 11.767f, 11.77f)
                close()
                moveTo(0.872f, 9.046f)
                curveToRelative(-0.566f, -0.336f, -1.162f, 0.402f, -0.715f, 0.885f)
                curveToRelative(4.434f, 4.793f, 9.078f, 9.426f, 13.911f, 13.912f)
