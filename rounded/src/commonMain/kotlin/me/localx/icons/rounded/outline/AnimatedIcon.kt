...
public val Icons.Outline.AnimatedIcon: ImageVector
    get() {
        if (_animatedIcon != null) {
            return _animatedIcon!!
        }
        _animatedIcon = Builder(name = "AnimatedIcon", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.63f, -0.36f, -1.37f, -0.36f, -2.0f, 0.0f)
                curveToRelative(-0.62f, 0.36f, -1.0f, 1.01f, -1.0f, 1.73f)
                verticalLineToRelative(3.99f)
                curveToRelative(0.0f, 0.72f, 0.37f, 1.37f, 1.0f, 1.73f)
