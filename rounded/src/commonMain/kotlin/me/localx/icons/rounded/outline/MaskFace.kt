...
public val Icons.Outline.MaskFace: ImageVector
    get() {
        if (_maskFace != null) {
            return _maskFace!!
        }
        _maskFace = Builder(name = "MaskFace", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.264f, 18.264f)
                curveToRelative(-2.346f, 2.346f, -4.69f, 3.205f, -6.065f, 3.521f)
                lineTo(3.677f, 13.261f)
                lineToRelative(0.759f, -2.623f)
                curveToRelative(0.251f, -0.866f, 0.449f, -1.821f, 0.607f, -2.921f)
                curveToRelative(0.161f, -1.125f, 0.442f, -1.845f, 0.636f, -2.039f)
                curveToRelative(0.194f, -0.193f, 0.915f, -0.476f, 2.04f, -0.636f)
                curveToRelative(1.099f, -0.158f, 2.055f, -0.356f, 2.92f, -0.606f)
                lineToRelative(2.625f, -0.76f)
                lineToRelative(8.522f, 8.522f)
                curveToRelative(-0.317f, 1.377f, -1.175f, 3.72f, -3.52f, 6.066f)
                close()
