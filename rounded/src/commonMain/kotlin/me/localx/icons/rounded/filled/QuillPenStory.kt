    ...
    get() {
        ...
        _quillPenStory = Builder(name = "QuillPenStory", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.445f, 1.78f, 2.045f, 3.029f, 3.88f, 3.029f)
                horizontalLineToRelative(8.043f)
                curveToRelative(1.835f, 0.0f, 3.434f, -1.248f, 3.88f, -3.028f)
                lineToRelative(0.009f, -0.036f)
                ...
                curveToRelative(3.213f, -2.281f, 4.89f, -5.53f, 5.447f, -7.362f)
                curveToRelative(0.224f, -0.736f, -0.326f, -1.467f, -1.095f, -1.467f)
                curveToRelative(-2.015f, 0.0f, -6.092f, 0.353f, -9.356f, 2.671f)
                close()
            }
        }
        .build()
