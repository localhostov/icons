        ...
        _frown = Builder(name = "Frown", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(16.01f, 18.0f)
                    curveTo(16.1646f, 17.9965f, 16.3164f, 17.9579f, 16.4539f, 17.8871f)
                    curveTo(16.5914f, 17.8164f, 16.7111f, 17.7153f, 16.8038f, 17.5916f)
                    curveTo(16.8966f, 17.4678f, 16.96f, 17.3246f, 16.9893f, 17.1728f)
                    curveTo(17.0186f, 17.0209f, 17.013f, 16.8644f, 16.973f, 16.715f)
                    curveTo(16.6187f, 15.6658f, 15.9542f, 14.7489f, 15.0675f, 14.0855f)
                    curveTo(14.1808f, 13.4222f, 13.1135f, 13.0436f, 12.007f, 13.0f)
                    curveTo(10.9016f, 13.0479f, 9.8364f, 13.428f, 8.9504f, 14.0908f)
                    curveTo(8.0645f, 14.7536f, 7.3991f, 15.6681f, 7.041f, 16.715f)
                    curveTo(6.9966f, 16.8643f, 6.9877f, 17.0218f, 7.015f, 17.1752f)
                    curveTo(7.0423f, 17.3285f, 7.105f, 17.4733f, 7.1981f, 17.5981f)
                    curveTo(7.2913f, 17.7229f, 7.4123f, 17.8242f, 7.5515f, 17.894f)
                    curveTo(7.6907f, 17.9638f, 7.8443f, 18.0001f, 8.0f, 18.0f)
                    horizontalLineTo(16.01f)
                    close()
                    moveTo(6.0f, 10.0f)
                    curveTo(6.0f, 11.0f, 6.895f, 11.0f, 8.0f, 11.0f)
                    curveTo(9.105f, 11.0f, 10.0f, 11.0f, 10.0f, 10.0f)
