    ...
    get() {
        ...
        _frown = Builder(name = "Frown", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(16.01f, 18.0f)
                arcToRelative(1.021f, 1.021f, 0.0f, false, false, 0.963f, -1.285f)
                arcTo(5.469f, 5.469f, 0.0f, false, false, 12.007f, 13.0f)
                arcToRelative(5.5f, 5.5f, 0.0f, false, false, -4.966f, 3.715f)
