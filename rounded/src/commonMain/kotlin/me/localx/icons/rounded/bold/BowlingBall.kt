    ...
    get() {
        ...
        _bowlingBall = Builder(name = "BowlingBall", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.0f, 11.5f)
                arcTo(1.5f, 1.5f, 0.0f, true, true, 11.5f, 10.0f)
                arcTo(1.5f, 1.5f, 0.0f, false, true, 13.0f, 11.5f)
                close()
                moveTo(8.0f, 10.5f)
                arcTo(1.5f, 1.5f, 0.0f, true, true, 6.5f, 9.0f)
                arcTo(1.5f, 1.5f, 0.0f, false, true, 8.0f, 10.5f)
                close()
                moveTo(9.5f, 8.0f)
                arcTo(1.5f, 1.5f, 0.0f, true, true, 11.0f, 6.5f)
