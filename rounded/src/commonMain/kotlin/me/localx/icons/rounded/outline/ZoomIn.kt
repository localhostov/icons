        ...
        _zoomIn = Builder(name = "ZoomIn", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    verticalLineTo(7.0f)
                    curveTo(11.0f, 6.7348f, 10.8946f, 6.4804f, 10.7071f, 6.2929f)
                    curveTo(10.5196f, 6.1054f, 10.2652f, 6.0f, 10.0f, 6.0f)
                    curveTo(9.7348f, 6.0f, 9.4804f, 6.1054f, 9.2929f, 6.2929f)
                    curveTo(9.1053f, 6.4804f, 9.0f, 6.7348f, 9.0f, 7.0f)
                    verticalLineTo(9.0f)
                    horizontalLineTo(7.0f)
                    curveTo(6.7348f, 9.0f, 6.4804f, 9.1053f, 6.2929f, 9.2929f)
                    ...
                    curveTo(9.0f, 13.2652f, 9.1053f, 13.5196f, 9.2929f, 13.7071f)
                    curveTo(9.4804f, 13.8946f, 9.7348f, 14.0f, 10.0f, 14.0f)
                    curveTo(10.2652f, 14.0f, 10.5196f, 13.8946f, 10.7071f, 13.7071f)
                    curveTo(10.8946f, 13.5196f, 11.0f, 13.2652f, 11.0f, 13.0f)
                    ...
                    curveTo(13.5196f, 9.1053f, 13.2652f, 9.0f, 13.0f, 9.0f)
                    close()
                }
            }
        }
