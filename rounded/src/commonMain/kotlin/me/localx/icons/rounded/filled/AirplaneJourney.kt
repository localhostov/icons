...
public val Icons.Filled.AirplaneJourney: ImageVector
    get() {
        ...
        _airplaneJourney = Builder(name = "AirplaneJourney", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveToRelative(17.26f, 10.292f)
                curveToRelative(0.48f, 0.469f, 1.11f, 0.704f, 1.74f, 0.704f)
                reflectiveCurveToRelative(1.26f, -0.235f, 1.74f, -0.704f)
                lineToRelative(1.795f, -1.756f)
                ...
                lineToRelative(1.788f, 1.748f)
                close()
                moveTo(20.501f, 4.788f)
                curveToRelative(0.0f, 0.828f, -0.672f, 1.5f, -1.5f, 1.5f)
                reflectiveCurveToRelative(-1.5f, -0.672f, -1.5f, -1.5f)
                reflectiveCurveToRelative(0.672f, -1.5f, 1.5f, -1.5f)
                reflectiveCurveToRelative(1.5f, 0.672f, 1.5f, 1.5f)
                close()
                moveTo(24.0f, 17.001f)
