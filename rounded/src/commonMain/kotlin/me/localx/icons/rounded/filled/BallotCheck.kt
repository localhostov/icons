    ...
    get() {
        ...
        _ballotCheck = Builder(name = "BallotCheck", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(-0.672f, 1.5f, -1.5f, 1.5f)
                close()
                moveTo(8.865f, 13.521f)
                curveToRelative(-0.319f, 0.319f, -0.741f, 0.479f, -1.165f, 0.479f)
                curveToRelative(-0.427f, 0.0f, -0.855f, -0.162f, -1.182f, -0.487f)
                lineToRelative(-0.681f, -0.655f)
                curveToRelative(-0.398f, -0.382f, -0.411f, -1.016f, -0.028f, -1.414f)
                curveToRelative(0.383f, -0.399f, 1.017f, -0.41f, 1.414f, -0.028f)
                lineToRelative(0.472f, 0.454f)
                lineToRelative(1.866f, -1.815f)
                curveToRelative(0.396f, -0.385f, 1.029f, -0.377f, 1.414f, 0.02f)
                curveToRelative(0.385f, 0.396f, 0.376f, 1.029f, -0.02f, 1.414f)
                lineToRelative(-2.091f, 2.034f)
                close()
                moveTo(17.0f, 19.0f)
