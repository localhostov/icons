    ...
    get() {
        ...
        _satelliteDish = Builder(name = "SatelliteDish", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-1.506f, 1.506f)
                close()
                moveTo(14.541f, 20.382f)
                lineTo(3.619f, 9.459f)
                curveToRelative(-2.355f, 3.052f, -2.135f, 7.464f, 0.662f, 10.261f)
                curveToRelative(2.796f, 2.796f, 7.207f, 3.015f, 10.26f, 0.662f)
                close()
            }
        }
        .build()
