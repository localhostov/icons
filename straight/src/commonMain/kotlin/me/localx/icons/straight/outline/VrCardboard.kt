    ...
    get() {
        ...
        _vrCardboard = Builder(name = "VrCardboard", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineToRelative(9.074f)
                lineToRelative(2.059f, -3.527f)
                curveToRelative(0.262f, -0.45f, 0.693f, -0.499f, 0.867f, -0.499f)
                reflectiveCurveToRelative(0.605f, 0.048f, 0.868f, 0.499f)
                lineToRelative(2.058f, 3.527f)
                horizontalLineToRelative(9.074f)
                lineTo(24.0f, 6.0f)
                curveToRelative(0.0f, -1.654f, -1.346f, -3.0f, -3.0f, -3.0f)
                close()
                moveTo(22.0f, 19.0f)
                horizontalLineToRelative(-5.926f)
                lineToRelative(-1.479f, -2.535f)
                curveToRelative(-0.545f, -0.934f, -1.515f, -1.491f, -2.596f, -1.491f)
                reflectiveCurveToRelative(-2.051f, 0.557f, -2.595f, 1.491f)
                lineToRelative(-1.479f, 2.535f)
                lineTo(2.0f, 19.0f)
                lineTo(2.0f, 6.0f)
