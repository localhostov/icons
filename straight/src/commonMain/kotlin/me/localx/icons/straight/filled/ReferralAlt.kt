...
public val Icons.Filled.ReferralAlt: ImageVector
    get() {
        ...
        _referralAlt = Builder(name = "ReferralAlt", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveToRelative(16.664f, 11.497f)
                lineToRelative(-3.94f, 3.503f)
                lineToRelative(3.94f, 3.503f)
                lineToRelative(-1.328f, 1.494f)
                lineToRelative(-4.497f, -3.997f)
