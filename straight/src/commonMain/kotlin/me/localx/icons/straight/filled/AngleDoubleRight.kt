        ...
        _angleDoubleRight = Builder(name = "AngleDoubleRight", defaultWidth = 24.0.dp, defaultHeight
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(20.8942f, 11.4805f, 20.9995f, 11.7348f, 20.9995f, 12.0f)
                    curveTo(20.9995f, 12.2652f, 20.8942f, 12.5195f, 20.7067f, 12.707f)
                    lineTo(10.8187f, 22.6f)
                    lineTo(12.2327f, 24.014f)
                    lineTo(22.1207f, 14.126f)
                    curveTo(22.6831f, 13.5634f, 22.9991f, 12.8005f, 22.9991f, 12.005f)
                    curveTo(22.9991f, 11.2095f, 22.6831f, 10.4466f, 22.1207f, 9.884f)
