        ...
        _crossCircle = Builder(name = "CrossCircle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    moveTo(16.8791f, 9.2421f)
                    lineTo(14.7581f, 7.1211f)
                    lineTo(12.0001f, 9.8791f)
                    lineTo(9.2421f, 7.1211f)
                    lineTo(7.1211f, 9.2421f)
                    lineTo(9.8791f, 12.0001f)
                    lineTo(7.1211f, 14.7581f)
                    lineTo(9.2421f, 16.8791f)
                    lineTo(12.0001f, 14.1211f)
                    lineTo(14.7581f, 16.8791f)
                    lineTo(16.8791f, 14.7581f)
                    lineTo(14.1211f, 12.0001f)
                    lineTo(16.8791f, 9.2421f)
                    close()
                }
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
