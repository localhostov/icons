...
public val Icons.Outline.TextBox: ImageVector
    get() {
        if (_textBox != null) {
            return _textBox!!
        }
        _textBox = Builder(name = "TextBox", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(6.0f, 0.0f)
                horizontalLineToRelative(-3.667f)
                curveTo(1.047f, 0.0f, 0.0f, 1.047f, 0.0f, 2.333f)
                verticalLineToRelative(3.667f)
                ...
                curveToRelative(0.184f, 0.0f, 0.333f, 0.149f, 0.333f, 0.333f)
                verticalLineToRelative(1.667f)
                horizontalLineToRelative(-2.0f)
                verticalLineToRelative(-2.0f)
                close()
                moveTo(2.0f, 2.333f)
                curveToRelative(0.0f, -0.184f, 0.149f, -0.333f, 0.333f, -0.333f)
                horizontalLineToRelative(1.667f)
                verticalLineToRelative(2.0f)
                horizontalLineToRelative(-2.0f)
                verticalLineToRelative(-1.667f)
