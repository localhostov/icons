    ...
    get() {
        ...
        _grillHotAlt = Builder(name = "GrillHotAlt", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(9.0f, 0.0f)
                close()
                moveTo(17.852f, 17.466f)
                lineToRelative(3.267f, 6.533f)
                ...
                lineToRelative(0.768f, -1.536f)
                curveTo(2.384f, 15.358f, 0.0f, 11.35f, 0.0f, 7.0f)
                verticalLineToRelative(-1.0f)
                horizontalLineToRelative(24.0f)
                verticalLineToRelative(1.0f)
                curveToRelative(0.0f, 4.35f, -2.384f, 8.358f, -6.148f, 10.466f)
                close()
                moveTo(21.949f, 8.0f)
                lineTo(2.051f, 8.0f)
                curveToRelative(0.348f, 3.428f, 2.467f, 6.481f, 5.61f, 8.0f)
                horizontalLineToRelative(8.679f)
                curveToRelative(3.143f, -1.519f, 5.262f, -4.571f, 5.609f, -8.0f)
                close()
            }
        }
        .build()
