...
public val Icons.Outline.CowbellCirclePlus: ImageVector
    get() {
        ...
        _cowbellCirclePlus = Builder(name = "CowbellCirclePlus", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineToRelative(2.0f)
                close()
                moveTo(8.056f, 18.001f)
                lineTo(2.436f, 18.001f)
                lineToRelative(1.607f, -10.352f)
                curveToRelative(0.17f, -0.955f, 0.999f, -1.648f, 1.969f, -1.648f)
                horizontalLineToRelative(9.977f)
                curveToRelative(0.97f, 0.0f, 1.798f, 0.693f, 1.969f, 1.648f)
                lineToRelative(0.073f, 0.41f)
                curveToRelative(0.738f, 0.084f, 1.449f, 0.257f, 2.122f, 0.509f)
                ...
                curveToRelative(-1.787f, -1.452f, -3.005f, -3.576f, -3.272f, -5.987f)
                close()
                moveTo(8.0f, 3.001f)
