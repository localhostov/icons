...
public val Icons.Bold.MessageSms: ImageVector
    get() {
        if (_messageSms != null) {
            return _messageSms!!
        }
        _messageSms = Builder(name = "MessageSms", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 11.0f)
                lineToRelative(-1.748f, -1.894f)
                lineToRelative(-0.002f, 3.894f)
                horizontalLineToRelative(-1.25f)
                verticalLineToRelative(-6.0f)
                horizontalLineToRelative(1.253f)
                lineToRelative(1.747f, 2.0f)
                lineToRelative(1.747f, -2.0f)
                horizontalLineToRelative(1.253f)
                verticalLineToRelative(6.0f)
                horizontalLineToRelative(-1.253f)
                verticalLineToRelative(-3.892f)
                lineToRelative(-1.747f, 1.892f)
                close()
                moveTo(5.197f, 8.962f)
                curveToRelative(0.016f, 0.0f, 0.614f, 0.263f, 1.272f, 0.506f)
                curveToRelative(1.223f, 0.451f, 1.529f, 1.336f, 1.408f, 2.014f)
                curveToRelative(-0.16f, 0.899f, -1.019f, 1.552f, -2.04f, 1.552f)
                curveToRelative(-0.826f, 0.0f, -1.603f, -0.333f, -2.13f, -0.914f)
