        ...
        _menuDots = Builder(name = "MenuDots", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = NonZero) {
                    moveTo(11.9999f, 14.0003f)
                    curveTo(13.1044f, 14.0003f, 13.9999f, 13.1049f, 13.9999f, 12.0003f)
                    curveTo(13.9999f, 10.8957f, 13.1044f, 10.0003f, 11.9999f, 10.0003f)
                    curveTo(10.8953f, 10.0003f, 9.9999f, 10.8957f, 9.9999f, 12.0003f)
                    curveTo(9.9999f, 13.1049f, 10.8953f, 14.0003f, 11.9999f, 14.0003f)
                    close()
                }
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
