...
public val Icons.Bold.Sad: ImageVector
    get() {
        ...
        _sad = Builder(name = "Sad", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(15.9583f, 13.8658f, 14.0241f, 13.0987f, 12.0f, 13.0f)
                    curveTo(9.9759f, 13.0987f, 8.0417f, 13.8658f, 6.5f, 15.181f)
                    lineTo(8.493f, 17.423f)
                    curveTo(9.4834f, 16.5919f, 10.7105f, 16.094f, 12.0f, 16.0f)
                    curveTo(13.2892f, 16.0942f, 14.5159f, 16.5921f, 15.506f, 17.423f)
                    lineTo(17.5f, 15.181f)
                    close()
                    moveTo(6.0f, 9.667f)
                    verticalLineTo(11.0f)
                    horizontalLineTo(11.0f)
                    verticalLineTo(9.667f)
                    curveTo(11.0216f, 8.982f, 10.7704f, 8.3164f, 10.3017f, 7.8163f)
                    curveTo(9.833f, 7.3163f, 9.185f, 7.0227f, 8.5f, 7.0f)
                    curveTo(7.815f, 7.0227f, 7.167f, 7.3163f, 6.6983f, 7.8163f)
                    curveTo(6.2296f, 8.3164f, 5.9784f, 8.982f, 6.0f, 9.667f)
                    close()
                    moveTo(13.0f, 9.667f)
                    verticalLineTo(11.0f)
