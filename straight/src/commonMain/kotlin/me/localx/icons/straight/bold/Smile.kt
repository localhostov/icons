        ...
        _smile = Builder(name = "Smile", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    lineTo(15.506f, 13.577f)
                    curveTo(14.516f, 14.4082f, 13.2892f, 14.9061f, 12.0f, 15.0f)
                    curveTo(10.7134f, 14.9066f, 9.4888f, 14.4105f, 8.5f, 13.582f)
                    lineTo(6.5f, 15.819f)
                    curveTo(8.042f, 17.1337f, 9.9761f, 17.9007f, 12.0f, 18.0f)
                    curveTo(14.024f, 17.9007f, 15.958f, 17.1337f, 17.5f, 15.819f)
                    close()
                    moveTo(6.0f, 9.667f)
