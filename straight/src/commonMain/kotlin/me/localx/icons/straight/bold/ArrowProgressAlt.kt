...
public val Icons.Bold.ArrowProgressAlt: ImageVector
    get() {
        ...
        _arrowProgressAlt = Builder(name = "ArrowProgressAlt", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineToRelative(-5.0f)
                close()
                moveTo(13.0f, 14.947f)
                verticalLineToRelative(3.066f)
                horizontalLineToRelative(-6.0f)
                verticalLineToRelative(3.0f)
                horizontalLineToRelative(6.0f)
                verticalLineToRelative(2.934f)
                lineToRelative(4.112f, -3.763f)
                curveToRelative(0.439f, -0.394f, 0.439f, -1.081f, 0.0f, -1.475f)
                lineToRelative(-4.112f, -3.763f)
                close()
                moveTo(19.0f, 17.0f)
                verticalLineToRelative(5.0f)
