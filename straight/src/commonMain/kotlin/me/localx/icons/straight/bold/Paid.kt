...
public val Icons.Bold.Paid: ImageVector
    get() {
        if (_paid != null) {
            return _paid!!
        }
        _paid = Builder(name = "Paid", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.347f, 6.0f)
                horizontalLineToRelative(13.304f)
                curveToRelative(-1.68f, -1.862f, -4.08f, -3.0f, -6.652f, -3.0f)
                reflectiveCurveToRelative(-4.972f, 1.138f, -6.652f, 3.0f)
                close()
                moveTo(13.8f, 8.0f)
                verticalLineToRelative(8.0f)
