        ...
        _unlock = Builder(name = "Unlock", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(20.0001f, 21.0009f)
                    curveTo(20.0001f, 21.2661f, 19.8948f, 21.5204f, 19.7072f, 21.708f)
                    curveTo(19.5197f, 21.8955f, 19.2653f, 22.0009f, 19.0001f, 22.0009f)
                    horizontalLineTo(5.0001f)
                    curveTo(4.7349f, 22.0009f, 4.4805f, 21.8955f, 4.293f, 21.708f)
                    curveTo(4.1055f, 21.5204f, 4.0001f, 21.2661f, 4.0001f, 21.0009f)
