    ...
    get() {
        ...
        _euro = Builder(name = "Euro", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineToRelative(-2.0f)
                horizontalLineToRelative(2.4f)
                arcToRelative(11.989f, 11.989f, 0.0f, false, true, 20.857f, -4.637f)
                lineToRelative(-1.542f, 1.274f)
                arcToRelative(10.0f, 10.0f, 0.0f, false, false, -17.254f, 3.363f)
                horizontalLineToRelative(11.539f)
                verticalLineToRelative(2.0f)
                horizontalLineToRelative(-11.949f)
                arcToRelative(9.829f, 9.829f, 0.0f, false, false, 0.0f, 2.0f)
                horizontalLineToRelative(11.949f)
                verticalLineToRelative(2.0f)
                horizontalLineToRelative(-11.539f)
                arcToRelative(10.0f, 10.0f, 0.0f, false, false, 17.254f, 3.363f)
