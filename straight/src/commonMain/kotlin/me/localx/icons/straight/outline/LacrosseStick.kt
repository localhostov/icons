...
public val Icons.Outline.LacrosseStick: ImageVector
    get() {
        ...
        _lacrosseStick = Builder(name = "LacrosseStick", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(20.97f, 11.044f)
                curveToRelative(-0.577f, 0.578f, -1.358f, 0.927f, -2.257f, 1.008f)
                curveToRelative(-1.47f, 0.132f, -2.87f, 0.991f, -3.84f, 2.357f)
                curveToRelative(-0.926f, 1.305f, -2.49f, 1.866f, -4.081f, 1.462f)
                curveToRelative(-1.292f, -0.326f, -2.337f, -1.371f, -2.663f, -2.662f)
                curveToRelative(-0.402f, -1.591f, 0.158f, -3.155f, 1.462f, -4.081f)
                curveToRelative(1.366f, -0.971f, 2.226f, -2.37f, 2.358f, -3.84f)
                curveToRelative(0.081f, -0.899f, 0.429f, -1.68f, 1.007f, -2.258f)
                curveToRelative(0.673f, -0.673f, 1.608f, -1.03f, 2.674f, -1.03f)
                curveToRelative(0.182f, 0.0f, 0.367f, 0.01f, 0.556f, 0.031f)
                curveToRelative(1.378f, 0.153f, 2.742f, 0.843f, 3.841f, 1.942f)
                reflectiveCurveToRelative(1.789f, 2.463f, 1.942f, 3.841f)
                curveToRelative(0.144f, 1.294f, -0.211f, 2.441f, -1.0f, 3.229f)
                close()
            }
        }
        .build()
