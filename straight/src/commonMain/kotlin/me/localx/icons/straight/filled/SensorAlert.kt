    ...
    get() {
        ...
        _sensorAlert = Builder(name = "SensorAlert", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(16.028f, 5.964f)
                lineToRelative(7.972f, 13.995f)
                lineTo(24.0f, 3.0f)
                ...
                reflectiveCurveToRelative(-0.448f, 1.0f, -1.0f, 1.0f)
                close()
                moveTo(16.026f, 10.0f)
                lineToRelative(-8.0f, 14.0f)
                horizontalLineToRelative(15.974f)
                lineToRelative(-7.974f, -14.0f)
                close()
                moveTo(17.0f, 22.0f)
