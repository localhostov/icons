...
public val Icons.Outline.ChartHistogram: ImageVector
    get() {
        ...
        _chartHistogram = Builder(name = "ChartHistogram", defaultWidth = 24.0.dp, defaultHeight =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = NonZero) {
                    moveTo(10.9998f, 4.4142f)
                    lineTo(15.9998f, 9.4142f)
                    lineTo(23.7068f, 1.7072f)
                    lineTo(22.2928f, 0.2932f)
                    lineTo(15.9998f, 6.5862f)
                    lineTo(10.9998f, 1.5862f)
                    lineTo(5.2929f, 7.2932f)
                    lineTo(6.7069f, 8.7072f)
                    lineTo(10.9998f, 4.4142f)
                    close()
                }
            }
        }
