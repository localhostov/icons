...
public val Icons.Filled.Swimmer: ImageVector
    get() {
        if (_swimmer != null) {
            return _swimmer!!
        }
        _swimmer = Builder(name = "Swimmer", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(3.0f, 18.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, -0.009f, 16.632f)
                lineTo(1.5f, 15.316f)
                ...
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, -4.0f, 0.0f)
                lineTo(5.0f, 19.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, -3.5f, 1.316f)
                lineTo(-0.009f, 21.632f)
                arcTo(3.97f, 3.97f, 0.0f, false, false, 6.0f, 21.618f)
                ...
                close()
                moveTo(18.254f, 12.0f)
                lineTo(11.416f, 2.274f)
                lineToRelative(0.0f, 0.0f)
                arcTo(3.0f, 3.0f, 0.0f, false, false, 8.961f, 1.0f)
                lineTo(2.0f, 1.0f)
                lineTo(2.0f, 3.0f)
                lineTo(8.961f, 3.0f)
                arcToRelative(1.006f, 1.006f, 0.0f, false, true, 0.818f, 0.424f)
