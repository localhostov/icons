...
public val Icons.Outline.ProgressUpload: ImageVector
    get() {
        ...
        _progressUpload = Builder(name = "ProgressUpload", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(0.119f, 10.304f)
                lineToRelative(1.98f, 0.279f)
                curveToRelative(0.133f, -0.939f, 0.399f, -1.854f, 0.792f, -2.718f)
                lineToRelative(-1.82f, -0.828f)
                curveToRelative(-0.472f, 1.038f, -0.792f, 2.138f, -0.952f, 3.267f)
                close()
