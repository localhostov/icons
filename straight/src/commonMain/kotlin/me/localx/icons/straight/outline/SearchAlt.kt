...
public val Icons.Outline.SearchAlt: ImageVector
    get() {
        if (_searchAlt != null) {
            return _searchAlt!!
        }
        _searchAlt = Builder(name = "SearchAlt", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(6.513f, 6.513f, 0.0f, false, true, 2.0f, 1.32f)
                ...
                arcToRelative(6.475f, 6.475f, 0.0f, false, true, -4.679f, -2.0f)
                close()
