        ...
        _hourglass = Builder(name = "Hourglass", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(3.0436f, 18.9629f, 3.4197f, 17.3609f, 4.1051f, 15.8835f)
                    curveTo(4.7906f, 14.4062f, 5.771f, 13.0846f, 6.986f, 12.0f)
                    curveTo(5.7706f, 10.9157f, 4.7901f, 9.5942f, 4.1045f, 8.1167f)
                    curveTo(3.419f, 6.6393f, 3.0432f, 5.0372f, 3.0f, 3.409f)
