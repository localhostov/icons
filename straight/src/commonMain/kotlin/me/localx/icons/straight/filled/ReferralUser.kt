...
public val Icons.Filled.ReferralUser: ImageVector
    get() {
        ...
        _referralUser = Builder(name = "ReferralUser", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(1.654f, 0.0f, 3.0f, 1.346f, 3.0f, 3.0f)
                close()
                moveTo(11.438f, 17.635f)
                curveToRelative(0.359f, 0.359f, 0.562f, 0.848f, 0.562f, 1.367f)
                curveToRelative(0.0f, 0.519f, -0.203f, 1.006f, -0.57f, 1.372f)
                lineToRelative(-3.484f, 3.565f)
                lineToRelative(-1.43f, -1.398f)
                lineToRelative(2.483f, -2.541f)
                lineTo(3.0f, 20.0f)
                curveToRelative(-1.654f, 0.0f, -3.0f, -1.346f, -3.0f, -3.0f)
                lineTo(0.0f, 7.0f)
                curveToRelative(0.0f, -1.654f, 1.346f, -3.0f, 3.0f, -3.0f)
