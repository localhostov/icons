...
public val Icons.Bold.Frown: ImageVector
    get() {
        if (_frown != null) {
            return _frown!!
        }
        _frown = Builder(name = "Frown", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(17.0f, 18.0f)
                    curveTo(16.9268f, 16.6989f, 16.3774f, 15.4703f, 15.4566f, 14.5482f)
                    curveTo(14.5358f, 13.6261f, 13.308f, 13.075f, 12.007f, 13.0f)
                    curveTo(9.0f, 13.0f, 7.0f, 16.0f, 7.0f, 18.0f)
