    ...
    get() {
        ...
        _usersAlt = Builder(name = "UsersAlt", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 12.0f, 17.0f)
                close()
                moveTo(18.0f, 21.0f)
                ...
                close()
                moveTo(6.0f, 13.0f)
                arcTo(5.968f, 5.968f, 0.0f, false, true, 7.537f, 9.0f)
                lineTo(3.0f, 9.0f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, -3.0f, 3.0f)
                verticalLineToRelative(3.0f)
                lineTo(6.349f, 15.0f)
                arcTo(5.971f, 5.971f, 0.0f, false, true, 6.0f, 13.0f)
                close()
                moveTo(17.651f, 15.0f)
                lineTo(24.0f, 15.0f)
                lineTo(24.0f, 12.0f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, -3.0f, -3.0f)
                lineTo(16.463f, 9.0f)
                arcToRelative(5.952f, 5.952f, 0.0f, false, true, 1.188f, 6.0f)
                close()
            }
        }
        .build()
