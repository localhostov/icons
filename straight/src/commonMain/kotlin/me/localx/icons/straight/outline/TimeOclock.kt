        ...
        _timeOclock = Builder(name = "TimeOclock", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(14.0f, 12.0f)
                    curveTo(14.0016f, 12.3515f, 13.9105f, 12.6971f, 13.736f, 13.0022f)
                    curveTo(13.5615f, 13.3072f, 13.3097f, 13.5609f, 13.0059f, 13.7377f)
                    curveTo(12.7021f, 13.9144f, 12.3571f, 14.008f, 12.0057f, 14.009f)
                    curveTo(11.6542f, 14.01f, 11.3087f, 13.9184f, 11.004f, 13.7434f)
                    curveTo(10.6992f, 13.5683f, 10.4459f, 13.3161f, 10.2697f, 13.012f)
                    curveTo(10.0934f, 12.7079f, 10.0004f, 12.3628f, 10.0f, 12.0113f)
                    curveTo(9.9996f, 11.6599f, 10.0918f, 11.3145f, 10.2674f, 11.01f)
                    curveTo(10.443f, 10.7056f, 10.6956f, 10.4527f, 11.0f, 10.277f)
                    verticalLineTo(6.0f)
                    horizontalLineTo(13.0f)
                    verticalLineTo(10.277f)
                    curveTo(13.3031f, 10.4513f, 13.5551f, 10.7023f, 13.7306f, 11.0047f)
                    curveTo(13.9061f, 11.3071f, 13.999f, 11.6503f, 14.0f, 12.0f)
                    close()
                }
            }
        }
