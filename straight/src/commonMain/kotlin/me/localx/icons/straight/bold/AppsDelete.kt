        ...
        _appsDelete = Builder(name = "AppsDelete", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = NonZero) {
                    moveTo(21.0001f, 16.0f)
                    verticalLineTo(21.0f)
                    horizontalLineTo(16.0001f)
                    verticalLineTo(16.0f)
                    horizontalLineTo(21.0001f)
                    close()
                    moveTo(24.0001f, 13.0f)
                    horizontalLineTo(13.0001f)
                    verticalLineTo(24.0f)
                    horizontalLineTo(21.0001f)
                    curveTo(21.7957f, 24.0f, 22.5588f, 23.6839f, 23.1214f, 23.1213f)
                    curveTo(23.684f, 22.5587f, 24.0001f, 21.7956f, 24.0001f, 21.0f)
                    verticalLineTo(13.0f)
                    close()
                }
            }
