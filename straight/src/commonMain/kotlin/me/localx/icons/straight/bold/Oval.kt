...
public val Icons.Bold.Oval: ImageVector
    get() {
        if (_oval != null) {
            return _oval!!
        }
        _oval = Builder(name = "Oval", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 7.0f)
                curveToRelative(-4.878f, 0.0f, -9.0f, 2.29f, -9.0f, 5.0f)
                reflectiveCurveToRelative(4.122f, 5.0f, 9.0f, 5.0f)
                reflectiveCurveToRelative(9.0f, -2.29f, 9.0f, -5.0f)
                reflectiveCurveToRelative(-4.122f, -5.0f, -9.0f, -5.0f)
                close()
            }
        }
