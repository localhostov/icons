    ...
    get() {
        ...
        _rv = Builder(name = "Rv", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(24.0f, 14.062f)
                arcToRelative(5.007f, 5.007f, 0.0f, false, false, -0.659f, -2.48f)
                lineTo(20.723f, 7.0f)
                lineTo(24.0f, 7.0f)
                close()
                moveTo(2.0f, 7.0f)
                ...
                lineTo(15.0f, 17.0f)
                lineTo(15.0f, 13.0f)
                horizontalLineToRelative(6.805f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, true, 0.2f, 1.062f)
                close()
                moveTo(15.0f, 11.0f)
                lineTo(15.0f, 8.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 1.0f, -1.0f)
                horizontalLineToRelative(2.42f)
                lineToRelative(2.286f, 4.0f)
                close()
                moveTo(16.0f, 5.0f)
