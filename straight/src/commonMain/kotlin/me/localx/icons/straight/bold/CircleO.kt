    ...
    get() {
        ...
        _circleO = Builder(name = "CircleO", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 5.75f)
                curveToRelative(-2.762f, 0.0f, -5.008f, 2.181f, -5.008f, 4.86f)
                verticalLineToRelative(2.779f)
                curveToRelative(0.0f, 2.68f, 2.247f, 4.86f, 5.008f, 4.86f)
                reflectiveCurveToRelative(4.992f, -2.181f, 4.992f, -4.86f)
                verticalLineToRelative(-2.779f)
                curveToRelative(0.0f, -2.68f, -2.239f, -4.86f, -4.992f, -4.86f)
                close()
                moveTo(13.992f, 13.39f)
                curveToRelative(0.0f, 1.043f, -0.875f, 1.86f, -1.992f, 1.86f)
                curveToRelative(-1.107f, 0.0f, -2.008f, -0.835f, -2.008f, -1.86f)
                verticalLineToRelative(-2.779f)
                curveToRelative(0.0f, -1.025f, 0.901f, -1.86f, 2.008f, -1.86f)
