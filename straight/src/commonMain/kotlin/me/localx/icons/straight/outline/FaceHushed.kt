    ...
    get() {
        ...
        _faceHushed = Builder(name = "FaceHushed", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-1.299f, 0.554f, -2.353f, 1.426f, -3.047f, 2.521f)
                lineToRelative(-1.689f, -1.07f)
                curveToRelative(0.912f, -1.439f, 2.279f, -2.577f, 3.953f, -3.29f)
                lineToRelative(0.783f, 1.84f)
                close()
                moveTo(19.764f, 7.948f)
                lineToRelative(-1.668f, 1.104f)
                curveToRelative(-0.695f, -1.052f, -1.729f, -1.891f, -2.988f, -2.428f)
                lineToRelative(0.785f, -1.84f)
                curveToRelative(1.62f, 0.69f, 2.959f, 1.785f, 3.871f, 3.164f)
                close()
                moveTo(10.0f, 11.5f)
