...
public val Icons.Bold.CalendarEventTax: ImageVector
    get() {
        ...
        _calendarEventTax = Builder(name = "CalendarEventTax", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.126f, -0.58f, 0.778f, -1.581f, 1.883f, -1.581f)
                reflectiveCurveToRelative(1.748f, 0.959f, 1.894f, 1.627f)
                close()
                moveTo(15.594f, 21.0f)
                lineToRelative(-0.701f, -3.019f)
                curveToRelative(-0.047f, -0.212f, -0.103f, -0.381f, -0.334f, -0.381f)
                reflectiveCurveToRelative(-0.292f, 0.193f, -0.319f, 0.321f)
