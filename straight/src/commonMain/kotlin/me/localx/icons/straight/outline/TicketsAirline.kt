...
public val Icons.Outline.TicketsAirline: ImageVector
    get() {
        ...
        _ticketsAirline = Builder(name = "TicketsAirline", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.551f, 0.0f, 1.0f, 0.448f, 1.0f, 1.0f)
                verticalLineToRelative(2.127f)
                curveToRelative(-1.723f, 0.444f, -3.0f, 2.013f, -3.0f, 3.873f)
                reflectiveCurveToRelative(1.277f, 3.429f, 3.0f, 3.873f)
                close()
                moveTo(17.0f, 11.0f)
