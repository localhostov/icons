    ...
    get() {
        ...
        _angleDoubleSmallRight = Builder(name = "AngleDoubleSmallRight", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(19.1001f, 10.586f)
                lineTo(13.8111f, 5.293f)
                lineTo(12.4001f, 6.707f)
                lineTo(17.6891f, 12.0f)
                lineTo(12.4001f, 17.293f)
                lineTo(13.8151f, 18.707f)
                lineTo(19.1001f, 13.414f)
                curveTo(19.4751f, 13.0389f, 19.6857f, 12.5303f, 19.6857f, 12.0f)
                curveTo(19.6857f, 11.4696f, 19.4751f, 10.961f, 19.1001f, 10.586f)
                close()
            }
            path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
