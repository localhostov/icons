    ...
    get() {
        ...
        _gasPumpSlash = Builder(name = "GasPumpSlash", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(22.174f, 20.76f)
                arcTo(3.0f, 3.0f, 0.0f, false, false, 24.0f, 18.0f)
                lineTo(24.0f, 5.414f)
                arcTo(2.015f, 2.015f, 0.0f, false, false, 23.414f, 4.0f)
                ...
                lineTo(22.0f, 18.0f)
                curveToRelative(0.036f, 0.9f, -1.1f, 1.189f, -1.666f, 0.92f)
