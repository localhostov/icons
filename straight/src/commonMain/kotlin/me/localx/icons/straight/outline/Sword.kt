    ...
    get() {
        ...
        _sword = Builder(name = "Sword", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(20.956f, 5.166f)
                lineTo(9.363f, 16.76f)
                arcToRelative(11.287f, 11.287f, 0.0f, false, false, -0.989f, -1.134f)
                arcToRelative(11.36f, 11.36f, 0.0f, false, false, -1.133f, -0.988f)
                lineToRelative(11.594f, -11.594f)
                lineToRelative(3.157f, -1.037f)
                close()
            }
        }
        .build()
