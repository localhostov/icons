    ...
    get() {
        ...
        _cameraCctv = Builder(name = "CameraCctv", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(4.573f, 7.214f)
                curveToRelative(-0.484f, -0.265f, -0.663f, -0.874f, -0.399f, -1.357f)
                lineToRelative(1.821f, -3.336f)
                curveToRelative(0.182f, -0.334f, 0.529f, -0.522f, 0.882f, -0.522f)
                curveToRelative(0.156f, 0.0f, 0.313f, 0.037f, 0.457f, 0.115f)
                lineToRelative(12.956f, 7.258f)
                lineToRelative(-0.865f, 0.619f)
                lineToRelative(-2.353f, 4.31f)
                lineTo(4.573f, 7.214f)
                close()
            }
        }
        .build()
