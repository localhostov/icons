        ...
        _timeDelete = Builder(name = "TimeDelete", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    moveTo(23.957f, 16.457f)
                    lineTo(20.914f, 19.5f)
                    lineTo(23.957f, 22.543f)
                    lineTo(22.543f, 23.957f)
                    lineTo(19.5f, 20.914f)
                    lineTo(16.457f, 23.957f)
                    lineTo(15.043f, 22.543f)
                    lineTo(18.086f, 19.5f)
                    lineTo(15.043f, 16.457f)
                    lineTo(16.457f, 15.043f)
                    lineTo(19.5f, 18.086f)
                    lineTo(22.543f, 15.043f)
                    lineTo(23.957f, 16.457f)
                    close()
                    moveTo(2.0f, 12.0f)
