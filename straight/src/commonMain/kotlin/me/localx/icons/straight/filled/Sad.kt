        ...
        _sad = Builder(name = "Sad", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(15.1135f, 16.7187f, 13.5945f, 16.1064f, 12.0f, 16.0f)
                    curveTo(10.4055f, 16.1064f, 8.8865f, 16.7187f, 7.664f, 17.748f)
                    lineTo(6.334f, 16.254f)
                    curveTo(7.9219f, 14.8975f, 9.9142f, 14.1049f, 12.0f, 14.0f)
                    curveTo(14.0858f, 14.1049f, 16.0781f, 14.8975f, 17.666f, 16.254f)
                    lineTo(16.336f, 17.748f)
                    close()
                    moveTo(14.0f, 11.0f)
                    verticalLineTo(10.0f)
