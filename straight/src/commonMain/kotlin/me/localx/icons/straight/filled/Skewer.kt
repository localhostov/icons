...
public val Icons.Filled.Skewer: ImageVector
    get() {
        if (_skewer != null) {
            return _skewer!!
        }
        _skewer = Builder(name = "Skewer", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.519f, 4.519f, 0.0f, false, false, 9.7f, 12.885f)
                ...
                lineTo(11.114f, 14.3f)
                arcToRelative(4.506f, 4.506f, 0.0f, false, false, 5.593f, -0.622f)
                lineToRelative(0.707f, -0.707f)
