...
public val Icons.Filled.PointOfSaleBill: ImageVector
    get() {
        ...
        _pointOfSaleBill = Builder(name = "PointOfSaleBill", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineToRelative(8.413f)
                curveToRelative(-1.768f, 1.061f, -3.027f, 2.876f, -3.334f, 5.0f)
                close()
                moveTo(24.0f, 6.0f)
                verticalLineToRelative(12.594f)
                lineToRelative(-3.126f, -1.9f)
                lineToRelative(-2.874f, 1.807f)
                lineToRelative(-2.0f, -1.257f)
                verticalLineToRelative(-7.243f)
                curveToRelative(0.0f, -1.628f, -0.791f, -3.064f, -2.0f, -3.976f)
