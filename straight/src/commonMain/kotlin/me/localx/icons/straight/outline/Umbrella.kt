        ...
        _umbrella = Builder(name = "Umbrella", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(2.05f, 13.0f)
                    curveTo(2.2976f, 10.5331f, 3.4528f, 8.2462f, 5.2913f, 6.583f)
                    curveTo(7.1299f, 4.9197f, 9.5208f, 3.9987f, 12.0f, 3.9987f)
                    curveTo(14.4793f, 3.9987f, 16.8701f, 4.9197f, 18.7087f, 6.583f)
                    curveTo(20.5472f, 8.2462f, 21.7024f, 10.5331f, 21.95f, 13.0f)
