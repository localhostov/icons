...
public val Icons.Bold.OvalAlt: ImageVector
    get() {
        if (_ovalAlt != null) {
            return _ovalAlt!!
        }
        _ovalAlt = Builder(name = "OvalAlt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(12.0f, 3.0f)
                curveToRelative(-2.71f, 0.0f, -5.0f, 4.122f, -5.0f, 9.0f)
                reflectiveCurveToRelative(2.29f, 9.0f, 5.0f, 9.0f)
                reflectiveCurveToRelative(5.0f, -4.122f, 5.0f, -9.0f)
                reflectiveCurveTo(14.71f, 3.0f, 12.0f, 3.0f)
                close()
            }
        }
        .build()
