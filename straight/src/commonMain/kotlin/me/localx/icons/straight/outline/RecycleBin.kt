...
public val Icons.Outline.RecycleBin: ImageVector
    get() {
        if (_recycleBin != null) {
            return _recycleBin!!
        }
        _recycleBin = Builder(name = "RecycleBin", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-0.571f, 5.137f)
                curveToRelative(-0.587f, -0.334f, -1.249f, -0.532f, -1.947f, -0.584f)
                lineToRelative(0.506f, -4.552f)
                lineTo(3.656f, 6.001f)
                lineToRelative(1.679f, 15.11f)
                curveToRelative(0.057f, 0.507f, 0.484f, 0.89f, 0.994f, 0.89f)
                horizontalLineToRelative(2.713f)
                curveToRelative(0.077f, 0.562f, 0.255f, 1.117f, 0.546f, 1.639f)
                close()
                moveTo(8.0f, 3.999f)
                horizontalLineToRelative(6.0f)
                verticalLineToRelative(-2.0f)
