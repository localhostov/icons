    ...
    get() {
        ...
        _milk = Builder(name = "Milk", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(16.324f, 6.0f)
                lineTo(3.714f, 6.0f)
                lineToRelative(-2.593f, 4.0f)
                horizontalLineToRelative(11.984f)
                lineToRelative(3.218f, -4.0f)
                close()
                moveTo(19.0f, 6.0f)
                lineToRelative(-4.0f, 4.88f)
                verticalLineToRelative(10.12f)
                curveToRelative(0.0f, 1.654f, 1.346f, 3.0f, 3.0f, 3.0f)
                horizontalLineToRelative(2.0f)
                curveToRelative(1.654f, 0.0f, 3.0f, -1.346f, 3.0f, -3.0f)
                verticalLineToRelative(-10.487f)
                lineToRelative(-4.0f, -4.513f)
                close()
            }
        }
        .build()
