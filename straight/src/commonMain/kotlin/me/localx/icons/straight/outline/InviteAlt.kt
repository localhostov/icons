...
public val Icons.Outline.InviteAlt: ImageVector
    get() {
        if (_inviteAlt != null) {
            return _inviteAlt!!
        }
        _inviteAlt = Builder(name = "InviteAlt", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineToRelative(12.715f)
                curveToRelative(-0.649f, -0.572f, -1.204f, -1.247f, -1.641f, -2.0f)
                lineTo(2.0f, 22.0f)
                verticalLineToRelative(-12.0f)
                horizontalLineToRelative(20.0f)
                verticalLineToRelative(1.074f)
                curveToRelative(0.753f, 0.436f, 1.428f, 0.992f, 2.0f, 1.641f)
                ...
                curveToRelative(0.0f, 1.012f, -0.378f, 1.937f, -1.0f, 2.643f)
                close()
                moveTo(19.5f, 16.5f)
                curveToRelative(0.0f, 0.828f, -0.672f, 1.5f, -1.5f, 1.5f)
