    ...
    get() {
        ...
        _globeAlt = Builder(name = "GlobeAlt", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(21.256f, 13.643f)
                arcToRelative(10.0f, 10.0f, 0.0f, true, true, -15.671f, -12.354f)
                lineToRelative(-1.485f, -1.342f)
                arcToRelative(11.993f, 11.993f, 0.0f, false, false, 7.9f, 20.0f)
