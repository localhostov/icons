...
public val Icons.Outline.ScaleComparisonAlt: ImageVector
    get() {
        ...
        _scaleComparisonAlt = Builder(name = "ScaleComparisonAlt", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveToRelative(8.955f, 13.141f)
                lineToRelative(0.082f, -2.141f)
                lineTo(-0.036f, 11.0f)
                lineToRelative(0.036f, 2.142f)
                curveToRelative(0.315f, 2.199f, 2.276f, 3.858f, 4.5f, 3.858f)
                reflectiveCurveToRelative(4.141f, -1.659f, 4.455f, -3.859f)
                close()
                moveTo(2.051f, 13.0f)
                horizontalLineToRelative(4.9f)
                curveToRelative(-0.232f, 1.15f, -1.262f, 2.0f, -2.45f, 2.0f)
                reflectiveCurveToRelative(-2.215f, -0.85f, -2.45f, -2.0f)
                close()
                moveTo(14.965f, 14.0f)
                lineToRelative(0.082f, 2.142f)
                curveToRelative(0.315f, 2.199f, 2.23f, 3.858f, 4.454f, 3.858f)
                reflectiveCurveToRelative(4.141f, -1.659f, 4.455f, -3.859f)
                lineToRelative(0.082f, -2.141f)
                horizontalLineToRelative(-9.072f)
                close()
                moveTo(19.501f, 18.0f)
                curveToRelative(-1.187f, 0.0f, -2.215f, -0.85f, -2.45f, -2.0f)
                horizontalLineToRelative(4.9f)
                curveToRelative(-0.232f, 1.15f, -1.262f, 2.0f, -2.45f, 2.0f)
                close()
