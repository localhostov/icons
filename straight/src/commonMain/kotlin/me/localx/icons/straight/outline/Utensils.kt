        ...
        _utensils = Builder(name = "Utensils", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    verticalLineTo(-1.0E-4f)
                    close()
                    moveTo(22.0002f, 9.2669f)
                    curveTo(22.0002f, 13.9439f, 18.1232f, 18.4579f, 17.0002f, 19.6669f)
                    verticalLineTo(23.9999f)
                    horizontalLineTo(15.0002f)
                    verticalLineTo(1.9999f)
                    curveTo(15.0001f, 1.5789f, 15.133f, 1.1686f, 15.3798f, 0.8274f)
                    curveTo(15.6267f, 0.4863f, 15.9749f, 0.2318f, 16.3748f, 0.1001f)
                    curveTo(16.7748f, -0.0315f, 17.2061f, -0.0336f, 17.6072f, 0.0942f)
                    curveTo(18.0084f, 0.222f, 18.3591f, 0.4732f, 18.6092f, 0.8119f)
                    curveTo(20.1552f, 2.8869f, 22.0002f, 6.0389f, 22.0002f, 9.2669f)
                    close()
                    moveTo(17.0002f, 16.5269f)
                    curveTo(20.9002f, 11.4989f, 20.9202f, 7.0499f, 17.0002f, 2.0069f)
                    verticalLineTo(16.5269f)
                    close()
                }
            }
        }
