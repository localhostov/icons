    ...
    get() {
        ...
        _hryvnia = Builder(name = "Hryvnia", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                horizontalLineTo(6.888f)
                curveToRelative(-1.134f, 0.499f, -1.888f, 1.752f, -1.888f, 3.0f)
                curveToRelative(0.0f, 1.164f, 0.606f, 2.3f, 1.582f, 2.822f)
                ...
                curveToRelative(-1.627f, -0.872f, -2.638f, -2.683f, -2.638f, -4.586f)
                curveToRelative(0.0f, -1.046f, 0.326f, -2.165f, 0.889f, -3.0f)
                ...
                verticalLineToRelative(-2.0f)
                horizontalLineToRelative(15.112f)
                curveToRelative(1.134f, -0.499f, 1.888f, -1.629f, 1.888f, -2.877f)
                ...
                curveToRelative(0.0f, 1.046f, -0.326f, 2.042f, -0.889f, 2.877f)
                horizontalLineToRelative(1.889f)
                verticalLineToRelative(2.0f)
