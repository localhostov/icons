...
public val Icons.Bold.DiceSix: ImageVector
    get() {
        if (_diceSix != null) {
            return _diceSix!!
        }
        _diceSix = Builder(name = "DiceSix", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(15.0f, 7.5f)
                arcTo(1.5f, 1.5f, 0.0f, true, false, 16.5f, 6.0f)
                arcTo(1.5f, 1.5f, 0.0f, false, false, 15.0f, 7.5f)
                close()
                moveTo(6.0f, 16.5f)
                arcTo(1.5f, 1.5f, 0.0f, true, false, 7.5f, 15.0f)
