    ...
    get() {
        ...
        _shoppingBasket = Builder(name = "ShoppingBasket", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(20.122f, 21.142f)
                curveToRelative(-0.069f, 0.489f, -0.495f, 0.858f, -0.989f, 0.858f)
                lineTo(4.867f, 22.0f)
                curveToRelative(-0.494f, 0.0f, -0.92f, -0.369f, -0.989f, -0.858f)
                lineToRelative(-1.592f, -11.142f)
