    ...
    get() {
        ...
        _snowflakes = Builder(name = "Snowflakes", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(17.874f, 11.712f)
                lineTo(15.586f, 14.0f)
                horizontalLineToRelative(-2.77f)
                arcToRelative(2.979f, 2.979f, 0.0f, false, false, -0.5f, -0.887f)
                ...
                arcToRelative(2.994f, 2.994f, 0.0f, false, false, -1.222f, 0.0f)
                lineTo(7.959f, 9.705f)
                lineTo(8.73f, 6.563f)
                lineTo(6.788f, 6.086f)
                lineTo(6.157f, 8.66f)
                lineTo(3.583f, 8.029f)
                lineTo(3.107f, 9.971f)
                lineToRelative(3.142f, 0.771f)
                lineToRelative(1.438f, 2.371f)
                arcToRelative(2.979f, 2.979f, 0.0f, false, false, -0.5f, 0.887f)
                horizontalLineTo(4.414f)
                lineTo(2.126f, 11.712f)
                ...
                lineTo(20.0f, 6.011f)
                lineTo(18.878f, 7.968f)
                lineToRelative(-1.735f, -1.0f)
                lineTo(18.274f, 5.0f)
                horizontalLineTo(16.0f)
                verticalLineTo(3.0f)
                horizontalLineToRelative(2.274f)
                lineTo(17.143f, 1.027f)
