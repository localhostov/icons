        ...
        _exclamation = Builder(name = "Exclamation", defaultWidth = 24.0.dp, defaultHeight =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = NonZero) {
                    moveTo(13.5f, 5.3185f)
                    horizontalLineTo(10.5f)
                    verticalLineTo(14.1545f)
                    horizontalLineTo(13.5f)
                    verticalLineTo(5.3185f)
                    close()
                }
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = NonZero) {
                    moveTo(13.5649f, 15.9943f)
                    horizontalLineTo(10.5649f)
                    verticalLineTo(18.9943f)
                    horizontalLineTo(13.5649f)
                    verticalLineTo(15.9943f)
                    close()
                }
            }
        }
