    ...
    get() {
        ...
        _angleDoubleSmallLeft = Builder(name = "AngleDoubleSmallLeft", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(18.1894f, 6.707f)
                lineTo(16.7754f, 5.293f)
                lineTo(10.7755f, 11.293f)
                curveTo(10.588f, 11.4805f, 10.4827f, 11.7348f, 10.4827f, 12.0f)
                curveTo(10.4827f, 12.2651f, 10.588f, 12.5194f, 10.7755f, 12.707f)
                lineTo(16.7754f, 18.707f)
                lineTo(18.1894f, 17.293f)
                lineTo(12.9004f, 12.0f)
                lineTo(18.1894f, 6.707f)
                close()
            }
        }
        .build()
