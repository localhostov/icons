...
public val Icons.Filled.SendMoney: ImageVector
    get() {
        if (_sendMoney != null) {
            return _sendMoney!!
        }
        _sendMoney = Builder(name = "SendMoney", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(21.239f, 9.0f)
                curveToRelative(0.485f, 1.241f, 0.761f, 2.587f, 0.761f, 4.0f)
                curveToRelative(0.0f, 6.075f, -4.925f, 11.0f, -11.0f, 11.0f)
                reflectiveCurveTo(0.0f, 19.075f, 0.0f, 13.0f)
                reflectiveCurveTo(4.925f, 2.0f, 11.0f, 2.0f)
                curveToRelative(1.413f, 0.0f, 2.759f, 0.276f, 4.0f, 0.761f)
                verticalLineToRelative(1.996f)
                lineToRelative(-1.535f, 1.535f)
