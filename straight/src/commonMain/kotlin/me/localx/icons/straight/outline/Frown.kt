        ...
        _frown = Builder(name = "Frown", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(17.0f, 18.0f)
                    curveTo(17.0f, 16.0f, 15.0f, 13.0f, 12.007f, 13.0f)
                    curveTo(10.7022f, 13.0815f, 9.471f, 13.6329f, 8.5413f, 14.5521f)
                    curveTo(7.6116f, 15.4713f, 7.0463f, 16.6962f, 6.95f, 18.0f)
