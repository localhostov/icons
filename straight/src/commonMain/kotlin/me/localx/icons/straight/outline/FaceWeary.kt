    ...
    get() {
        ...
        _faceWeary = Builder(name = "FaceWeary", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.498f, 0.303f, 1.136f, 0.424f, 1.706f, 0.332f)
                ...
                curveToRelative(0.564f, 0.096f, 1.195f, -0.027f, 1.686f, -0.328f)
                lineToRelative(1.041f, 1.708f)
                close()
                moveTo(18.0f, 18.001f)
                reflectiveCurveToRelative(-3.007f, -1.0f, -6.007f, -1.0f)
                reflectiveCurveToRelative(-6.0f, 1.001f, -6.0f, 1.0f)
