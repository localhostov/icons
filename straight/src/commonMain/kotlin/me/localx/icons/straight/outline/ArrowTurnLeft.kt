...
public val Icons.Outline.ArrowTurnLeft: ImageVector
    get() {
        if (_arrowTurnLeft != null) {
            return _arrowTurnLeft!!
        }
        _arrowTurnLeft = Builder(name = "ArrowTurnLeft", defaultWidth = 24.0.dp, defaultHeight =
