...
public val Icons.Outline.HandsHeart: ImageVector
    get() {
        if (_handsHeart != null) {
            return _handsHeart!!
        }
        _handsHeart = Builder(name = "HandsHeart", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.13f, -0.157f, 0.192f, -0.369f, 0.188f, -0.586f)
                curveToRelative(-0.018f, -0.212f, -0.101f, -0.498f, -0.254f, -0.669f)
                curveToRelative(-0.367f, -0.409f, -0.998f, -0.444f, -1.406f, -0.077f)
                lineToRelative(-2.908f, 2.676f)
                curveToRelative(0.366f, 0.507f, 0.568f, 1.122f, 0.568f, 1.756f)
                verticalLineToRelative(6.314f)
                horizontalLineToRelative(-2.0f)
                verticalLineToRelative(-6.314f)
                curveToRelative(0.0f, -0.279f, -0.118f, -0.547f, -0.323f, -0.735f)
                lineToRelative(-4.026f, -3.705f)
                curveToRelative(-0.398f, -0.357f, -1.03f, -0.324f, -1.397f, 0.086f)
                ...
                curveToRelative(0.998f, -0.35f, 2.153f, -0.161f, 2.996f, 0.594f)
                lineToRelative(3.004f, 2.764f)
                lineToRelative(2.995f, -2.756f)
                curveToRelative(0.85f, -0.761f, 2.006f, -0.952f, 3.005f, -0.602f)
                verticalLineToRelative(-5.171f)
                curveToRelative(0.0f, -1.654f, 1.346f, -3.0f, 3.0f, -3.0f)
                reflectiveCurveToRelative(3.0f, 1.346f, 3.0f, 3.0f)
                close()
                ...
                curveToRelative(0.0f, 2.651f, -3.69f, 5.348f, -4.43f, 5.861f)
                lineToRelative(-0.57f, 0.396f)
                lineToRelative(-0.57f, -0.396f)
                curveToRelative(-0.74f, -0.514f, -4.43f, -3.21f, -4.43f, -5.861f)
                close()
                moveTo(8.981f, 3.16f)
                curveToRelative(0.0f, 1.052f, 1.604f, 2.71f, 3.0f, 3.797f)
                curveToRelative(1.395f, -1.089f, 3.0f, -2.75f, 3.0f, -3.797f)
