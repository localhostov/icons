    ...
    get() {
        ...
        __70sMusicDisc = Builder(name = "_70sMusicDisc", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(1.36f, -0.394f, 1.71f, -0.976f)
                ...
                curveToRelative(-0.503f, 5.046f, -4.774f, 9.0f, -9.95f, 9.0f)
                ...
                lineTo(11.0f, 1.503f)
                lineToRelative(-4.132f, 7.271f)
                lineToRelative(-1.747f, -0.974f)
                lineToRelative(3.231f, -5.8f)
                close()
