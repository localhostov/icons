    ...
    get() {
        ...
        _drawPolygon = Builder(name = "DrawPolygon", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.221f, 0.0f, -0.435f, 0.027f, -0.642f, 0.073f)
                lineToRelative(-4.525f, -5.128f)
                curveToRelative(0.1f, -0.299f, 0.167f, -0.613f, 0.167f, -0.945f)
                reflectiveCurveToRelative(-0.067f, -0.646f, -0.167f, -0.945f)
                lineToRelative(4.525f, -5.128f)
                curveToRelative(0.207f, 0.045f, 0.421f, 0.073f, 0.642f, 0.073f)
                ...
                moveTo(5.0f, 18.778f)
                lineTo(5.0f, 5.222f)
                curveToRelative(0.078f, -0.07f, 0.152f, -0.144f, 0.222f, -0.222f)
