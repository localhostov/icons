        ...
        _layers = Builder(name = "Layers", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    moveTo(23.9443f, 7.6616f)
                    lineTo(12.0003f, 0.4996f)
                    lineTo(0.0563f, 7.6616f)
                    lineTo(12.0003f, 14.8276f)
                    lineTo(23.9443f, 7.6616f)
                    close()
                    moveTo(12.0003f, 2.8276f)
                    lineTo(20.0563f, 7.6616f)
                    lineTo(12.0003f, 12.4996f)
                    lineTo(3.9443f, 7.6616f)
                    lineTo(12.0003f, 2.8276f)
                    close()
                }
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
