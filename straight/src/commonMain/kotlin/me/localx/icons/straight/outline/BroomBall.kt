    ...
    get() {
        ...
        _broomBall = Builder(name = "BroomBall", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-1.853f, -1.853f)
                close()
                moveTo(10.062f, 18.463f)
                curveToRelative(-0.869f, 0.87f, -4.412f, 1.978f, -7.213f, 2.688f)
                curveToRelative(0.709f, -2.8f, 1.817f, -6.343f, 2.688f, -7.213f)
                curveToRelative(0.604f, -0.604f, 1.408f, -0.937f, 2.263f, -0.937f)
                reflectiveCurveToRelative(1.658f, 0.333f, 2.263f, 0.937f)
                curveToRelative(0.604f, 0.604f, 0.938f, 1.408f, 0.938f, 2.263f)
                reflectiveCurveToRelative(-0.333f, 1.658f, -0.938f, 2.263f)
                close()
            }
        }
        .build()
