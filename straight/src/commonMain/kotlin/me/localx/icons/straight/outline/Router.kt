...
public val Icons.Outline.Router: ImageVector
    get() {
        if (_router != null) {
            return _router!!
        }
        _router = Builder(name = "Router", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.481f, 4.907f)
                lineToRelative(-1.414f, -1.414f)
                curveTo(9.32f, 1.241f, 12.314f, 0.0f, 15.5f, 0.0f)
                reflectiveCurveToRelative(6.18f, 1.241f, 8.433f, 3.493f)
                lineToRelative(-1.414f, 1.414f)
                curveToRelative(-1.875f, -1.875f, -4.368f, -2.907f, -7.019f, -2.907f)
                reflectiveCurveToRelative(-5.144f, 1.033f, -7.019f, 2.907f)
                close()
                moveTo(6.0f, 19.5f)
