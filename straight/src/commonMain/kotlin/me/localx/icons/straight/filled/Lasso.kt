        ...
        _lasso = Builder(name = "Lasso", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(2.0096f, 10.0706f, 2.2454f, 11.1271f, 2.6922f, 12.1f)
                    curveTo(2.3375f, 12.5203f, 2.1081f, 13.0318f, 2.0299f, 13.5762f)
                    curveTo(1.9518f, 14.1205f, 2.0281f, 14.6759f, 2.2502f, 15.179f)
                    curveTo(0.8938f, 16.4264f, 0.0851f, 18.1592f, 2.0E-4f, 20.0f)
                    curveTo(-0.0153f, 20.5295f, 0.0776f, 21.0566f, 0.2731f, 21.5489f)
                    curveTo(0.4687f, 22.0412f, 0.7627f, 22.4883f, 1.1373f, 22.8629f)
                    curveTo(1.5119f, 23.2375f, 1.959f, 23.5315f, 2.4513f, 23.7271f)
                    curveTo(2.9436f, 23.9226f, 3.4707f, 24.0155f, 4.0002f, 24.0f)
                    lineTo(4.0082f, 22.0f)
                    curveTo(3.7405f, 22.018f, 3.4721f, 21.9787f, 3.2208f, 21.8847f)
                    curveTo(2.9696f, 21.7907f, 2.7413f, 21.6441f, 2.5512f, 21.4548f)
                    curveTo(2.3611f, 21.2655f, 2.2136f, 21.0378f, 2.1186f, 20.7869f)
                    curveTo(2.0236f, 20.536f, 1.9832f, 20.2677f, 2.0002f, 20.0f)
                    curveTo(2.0926f, 18.6819f, 2.697f, 17.4523f, 3.6842f, 16.574f)
                    curveTo(4.7965f, 16.9018f, 5.9543f, 17.0487f, 7.1132f, 17.009f)
                    curveTo(7.4132f, 17.009f, 7.6902f, 17.002f, 7.9562f, 16.993f)
                    curveTo(9.5541f, 17.66f, 11.2687f, 18.0023f, 13.0002f, 18.0f)
                    ...
                    curveTo(11.6657f, 15.9991f, 10.3423f, 15.7579f, 9.0932f, 15.288f)
                    curveTo(8.5882f, 14.0648f, 7.9176f, 12.9167f, 7.1002f, 11.876f)
                    curveTo(6.7504f, 11.5382f, 6.3246f, 11.2892f, 5.8586f, 11.15f)
                    curveTo(5.3926f, 11.0108f, 4.9f, 10.9854f, 4.4222f, 11.076f)
                    curveTo(4.1503f, 10.4173f, 4.007f, 9.7126f, 4.0002f, 9.0f)
