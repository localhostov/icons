        ...
        _download = Builder(name = "Download", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = NonZero) {
                    moveTo(22.0f, 16.0004f)
                    verticalLineTo(21.0004f)
                    curveTo(22.0f, 21.2656f, 21.8946f, 21.5199f, 21.7071f, 21.7075f)
                    curveTo(21.5196f, 21.895f, 21.2652f, 22.0004f, 21.0f, 22.0004f)
                    horizontalLineTo(3.0f)
                    curveTo(2.7348f, 22.0004f, 2.4804f, 21.895f, 2.2929f, 21.7075f)
                    curveTo(2.1054f, 21.5199f, 2.0f, 21.2656f, 2.0f, 21.0004f)
