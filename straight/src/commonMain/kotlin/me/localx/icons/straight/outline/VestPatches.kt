...
public val Icons.Outline.VestPatches: ImageVector
    get() {
        ...
        _vestPatches = Builder(name = "VestPatches", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(11.0f, 12.176f)
                lineTo(7.344f, 2.121f)
                curveToRelative(-0.503f, 0.064f, -1.07f, 0.161f, -1.626f, 0.309f)
                curveToRelative(-0.423f, 0.113f, -0.718f, 0.509f, -0.718f, 0.963f)
                verticalLineToRelative(4.606f)
                curveToRelative(0.0f, 1.646f, -1.405f, 3.602f, -2.0f, 4.356f)
                verticalLineToRelative(9.644f)
                lineTo(11.0f, 21.999f)
                lineTo(11.0f, 12.176f)
                close()
                moveTo(12.0f, 9.074f)
