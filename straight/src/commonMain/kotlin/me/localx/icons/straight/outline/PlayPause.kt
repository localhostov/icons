    ...
    get() {
        ...
        _playPause = Builder(name = "PlayPause", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(4.0f, 6.651f)
                verticalLineToRelative(10.689f)
                lineToRelative(7.793f, -4.995f)
                curveToRelative(0.134f, -0.084f, 0.207f, -0.213f, 0.207f, -0.359f)
                reflectiveCurveToRelative(-0.069f, -0.273f, -0.19f, -0.35f)
                lineTo(4.0f, 6.651f)
                close()
            }
        }
