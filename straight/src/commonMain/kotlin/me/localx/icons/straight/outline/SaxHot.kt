...
public val Icons.Outline.SaxHot: ImageVector
    get() {
        if (_saxHot != null) {
            return _saxHot!!
        }
        _saxHot = Builder(name = "SaxHot", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(1.011f, 7.0f)
                curveToRelative(0.0f, -1.582f, 1.077f, -3.059f, 1.989f, -4.0f)
                curveToRelative(0.0f, 0.0f, 0.453f, 2.03f, 1.008f, 2.03f)
                curveToRelative(1.158f, 0.0f, 0.823f, -3.103f, 2.492f, -5.03f)
                curveToRelative(1.737f, 1.737f, 5.5f, 3.815f, 5.5f, 7.0f)
                lineTo(1.011f, 7.0f)
                close()
            }
        }
