    ...
    get() {
        ...
        _phoneCall = Builder(name = "PhoneCall", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(12.133f, 12.133f, 0.0f, false, true, 7.747f, 9.793f)
                ...
                arcTo(3.9f, 3.9f, 0.0f, false, true, 16.5f, 22.0f)
                ...
                lineTo(22.0f, 10.0f)
                arcTo(8.009f, 8.009f, 0.0f, false, false, 14.0f, 2.0f)
                close()
                moveTo(14.0f, 6.0f)
                lineTo(14.0f, 4.0f)
                arcToRelative(6.006f, 6.006f, 0.0f, false, true, 6.0f, 6.0f)
                lineTo(18.0f, 10.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 14.0f, 6.0f)
                close()
            }
        }
        .build()
