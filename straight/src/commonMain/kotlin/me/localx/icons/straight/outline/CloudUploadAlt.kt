...
public val Icons.Outline.CloudUploadAlt: ImageVector
    get() {
        ...
        _cloudUploadAlt = Builder(name = "CloudUploadAlt", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(2.79f, 0.0f, 5.266f, 1.774f, 6.158f, 4.415f)
                lineToRelative(0.19f, 0.564f)
                lineToRelative(0.588f, 0.101f)
                curveToRelative(2.645f, 0.454f, 4.563f, 2.733f, 4.563f, 5.42f)
                curveToRelative(0.0f, 3.032f, -2.468f, 5.5f, -5.5f, 5.5f)
                close()
                moveTo(13.414f, 9.586f)
