        ...
        _frown = Builder(name = "Frown", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(7.0f, 16.0f, 9.028f, 13.0f, 12.007f, 13.0f)
                    curveTo(13.308f, 13.075f, 14.5358f, 13.6261f, 15.4566f, 14.5482f)
                    curveTo(16.3774f, 15.4703f, 16.9268f, 16.6989f, 17.0f, 18.0f)
                    close()
                    moveTo(14.0f, 11.0f)
                    verticalLineTo(10.0f)
