...
public val Icons.Outline.CalendarImage: ImageVector
    get() {
        ...
        _calendarImage = Builder(name = "CalendarImage", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(2.0f, 21.97f)
                lineToRelative(8.385f, -8.384f)
                lineToRelative(4.0f, 4.0f)
                lineToRelative(7.585f, -7.586f)
                lineTo(2.0f, 10.0f)
                verticalLineToRelative(11.97f)
                close()
                moveTo(22.0f, 12.798f)
                lineToRelative(-7.615f, 7.616f)
                lineToRelative(-4.0f, -4.0f)
                lineToRelative(-5.586f, 5.586f)
                horizontalLineToRelative(17.202f)
