        ...
        _notebook = Builder(name = "Notebook", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF374957)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(19.0f, 21.0f)
                    curveTo(19.0f, 21.2652f, 18.8946f, 21.5196f, 18.7071f, 21.7071f)
                    curveTo(18.5196f, 21.8946f, 18.2652f, 22.0f, 18.0f, 22.0f)
                    horizontalLineTo(6.0f)
                    curveTo(5.7348f, 22.0f, 5.4804f, 21.8946f, 5.2929f, 21.7071f)
                    curveTo(5.1054f, 21.5196f, 5.0f, 21.2652f, 5.0f, 21.0f)
                    verticalLineTo(4.0f)
                    horizontalLineTo(19.0f)
                    verticalLineTo(21.0f)
                    close()
