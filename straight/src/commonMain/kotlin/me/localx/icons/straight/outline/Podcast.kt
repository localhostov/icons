...
public val Icons.Outline.Podcast: ImageVector
    get() {
        if (_podcast != null) {
            return _podcast!!
        }
        _podcast = Builder(name = "Podcast", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.236f, 18.287f)
                curveToRelative(-0.869f, -0.279f, -1.2f, -0.287f, -1.235f, -0.287f)
                curveToRelative(-0.035f, 0.0f, -0.361f, 0.008f, -1.222f, 0.283f)
                lineToRelative(0.827f, 3.717f)
                horizontalLineToRelative(0.846f)
                lineToRelative(0.785f, -3.713f)
                close()
