    ...
    get() {
        ...
        _bikingMountain = Builder(name = "BikingMountain", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(10.017f, 10.533f)
                arcToRelative(0.98f, 0.98f, 0.0f, false, true, 0.3f, -0.713f)
                curveToRelative(0.169f, -0.16f, 2.659f, -2.445f, 2.659f, -2.445f)
                lineToRelative(4.4f, 4.337f)
                lineToRelative(1.4f, -1.424f)
                lineToRelative(-5.077f, -5.0f)
                ...
                arcTo(0.989f, 0.989f, 0.0f, false, true, 10.017f, 10.533f)
                close()
                moveTo(19.0f, 2.5f)
