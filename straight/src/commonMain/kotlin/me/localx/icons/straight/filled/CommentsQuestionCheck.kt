    ...
    get() {
        ...
        _commentsQuestionCheck = Builder(name = "CommentsQuestionCheck", defaultWidth = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(1.751f, -0.013f, 3.399f, -0.444f, 4.864f, -1.184f)
                lineToRelative(1.653f, 1.602f)
                curveToRelative(0.391f, 0.391f, 0.904f, 0.586f, 1.417f, 0.586f)
                curveToRelative(0.51f, 0.0f, 1.019f, -0.193f, 1.403f, -0.578f)
                lineToRelative(3.793f, -3.707f)
                lineToRelative(-1.398f, -1.43f)
                lineToRelative(-3.812f, 3.704f)
                lineToRelative(-1.313f, -1.273f)
                curveToRelative(2.596f, -1.995f, 4.284f, -5.114f, 4.309f, -8.636f)
