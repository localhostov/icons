...
public val Icons.Outline.SquareY: ImageVector
    get() {
        if (_squareY != null) {
            return _squareY!!
        }
        _squareY = Builder(name = "SquareY", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.359f, 5.0f)
                lineToRelative(-5.359f, 7.318f)
                verticalLineToRelative(6.682f)
                horizontalLineToRelative(-2.0f)
                verticalLineToRelative(-6.663f)
                lineToRelative(-5.385f, -7.337f)
                horizontalLineToRelative(2.48f)
                lineToRelative(3.898f, 5.309f)
                lineToRelative(3.884f, -5.309f)
                horizontalLineToRelative(2.48f)
                close()
            }
        }
