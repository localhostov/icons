    ...
    get() {
        ...
        _swipeRight = Builder(name = "SwipeRight", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.274f, 0.004f, 0.521f, 0.085f, 0.774f, 0.319f)
                ...
                lineTo(20.732f, -0.053f)
                lineToRelative(2.761f, 2.761f)
                curveToRelative(0.694f, 0.696f, 0.693f, 1.825f, 0.0f, 2.519f)
                close()
            }
        }
        .build()
