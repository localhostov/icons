    ...
    get() {
        ...
        _biking = Builder(name = "Biking", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(13.0f, 13.54f)
                lineTo(10.365f, 11.277f)
                arcToRelative(0.986f, 0.986f, 0.0f, false, true, -0.348f, -0.743f)
                arcToRelative(0.967f, 0.967f, 0.0f, false, true, 0.274f, -0.709f)
                lineToRelative(1.963f, -1.564f)
                arcToRelative(1.01f, 1.01f, 0.0f, false, true, 1.418f, 0.068f)
                lineTo(16.557f, 11.0f)
                lineTo(20.0f, 11.0f)
                lineTo(20.0f, 9.0f)
                lineTo(17.34f, 9.0f)
                lineTo(15.063f, 6.892f)
                arcToRelative(2.975f, 2.975f, 0.0f, false, false, -4.105f, -0.152f)
                lineTo(8.994f, 8.3f)
