...
public val Icons.Outline.LacrosseStickBall: ImageVector
    get() {
        ...
        _lacrosseStickBall = Builder(name = "LacrosseStickBall", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.872f, 14.409f)
                curveToRelative(-0.926f, 1.305f, -2.492f, 1.866f, -4.081f, 1.462f)
                curveToRelative(-1.292f, -0.326f, -2.337f, -1.371f, -2.663f, -2.662f)
                curveToRelative(-0.402f, -1.591f, 0.158f, -3.155f, 1.462f, -4.081f)
                curveToRelative(1.367f, -0.971f, 2.227f, -2.371f, 2.358f, -3.84f)
                curveToRelative(0.081f, -0.899f, 0.429f, -1.68f, 1.007f, -2.258f)
                curveToRelative(0.698f, -0.698f, 1.648f, -1.035f, 2.681f, -1.035f)
                curveToRelative(1.465f, 0.0f, 3.094f, 0.681f, 4.391f, 1.978f)
                curveToRelative(1.1f, 1.099f, 1.789f, 2.463f, 1.941f, 3.841f)
                curveToRelative(0.145f, 1.294f, -0.211f, 2.441f, -1.0f, 3.23f)
                curveToRelative(-0.576f, 0.578f, -1.357f, 0.926f, -2.257f, 1.007f)
                curveToRelative(-1.47f, 0.132f, -2.869f, 0.991f, -3.84f, 2.357f)
                close()
                moveTo(20.5f, 17.0f)
